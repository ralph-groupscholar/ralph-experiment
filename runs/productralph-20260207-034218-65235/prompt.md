...
Instructions:
Create a concise assessment template with scoring rubric, evidence checklist, and readiness gates. Include sections for data sources, identity matching, privacy review, and operational readiness. Deliver as markdown with tables.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-034218-65235"
```
