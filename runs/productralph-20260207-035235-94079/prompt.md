...
Instructions:
Provide an end-to-end workflow plus a form template for educators to report classroom incidents in Ralph Slack, including routing, privacy considerations, and response SLAs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-035235-94079"
```
