...
Instructions:
Draft a framework that defines compliance debt categories, intake criteria, severity scoring, triage workflow, ownership, SLAs, reporting metrics, and a dashboard view spec. Include a sample backlog table schema and weekly review agenda.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-051603-5740"
```
