...
Instructions:
Produce 4-6 core user personas for the Ralph Dashboard, each with goals, key tasks, data needs, and success signals. Keep tone in third person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-014050-27320"
```
