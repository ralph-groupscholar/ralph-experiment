...
Instructions:
Draft a Ralph Dashboard data governance plan covering stewardship roles, data access approvals, lineage tracking, and review cadence. Write in third person verbs and avoid questions.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-013255-5403"
```
