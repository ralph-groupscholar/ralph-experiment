...
Instructions:
Create a step-by-step validation procedure for backup restores, include RTO/RPO checks, data integrity validation, access controls verification, and post-restore sign-off. Deliver a concise SOP with checklists and evidence artifacts.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-024131-87183"
```
