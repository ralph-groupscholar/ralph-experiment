...
Instructions:
Create a workflow spec for accepting/recording data-sharing risks with partners: intake form, review steps, approvals, compensating controls, renewal cadence, and audit trail requirements. Deliver in org/ with forms and RACI.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-040241-22495"
```
