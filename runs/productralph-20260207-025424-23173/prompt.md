...
Instructions:
Design a monthly exec review pack outline with sections, KPIs, risk highlights, roadmap progress, and decisions; include a slide-by-slide list and metrics glossary; deliver as markdown in org/
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-025424-23173"
```
