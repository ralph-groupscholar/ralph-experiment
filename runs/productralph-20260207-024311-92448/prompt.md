...
Instructions:
Create an escalation tree for district communications during incidents and major releases. Include roles, channels, and timing. Use third-person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-024311-92448"
```
