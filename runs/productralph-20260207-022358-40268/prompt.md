...
Instructions:
Draft a Ralph Dashboard data quality remediation workflow with roles, SLAs, escalation steps, and evidence capture. Deliver as org documentation with third-person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-022358-40268"
```
