...
Instructions:
Produce an operating model doc covering roles, decision rights, cadences, committee structure, and integration with district leadership.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-031701-89540"
```
