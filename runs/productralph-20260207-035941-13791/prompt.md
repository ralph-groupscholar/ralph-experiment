...
Instructions:
Produce a facilitator kit: objectives, roles, pre-reads, scenario cards, timing, debrief prompts, and a scoring sheet.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-035941-13791"
```
