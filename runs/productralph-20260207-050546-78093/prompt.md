...
Instructions:
Create a spec for a monthly/quarterly reporting pack: metrics, data sources, ownership, validation, and distribution cadence. Include sample tables and visualization descriptions.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-050546-78093"
```
