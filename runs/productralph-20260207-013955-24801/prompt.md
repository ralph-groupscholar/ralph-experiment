...
Instructions:
Create a reusable data contract template with schema versioning, SLAs, ownership, validation rules, and deprecation policy for dashboard feeds.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-013955-24801"
```
