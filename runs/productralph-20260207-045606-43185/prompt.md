...
Instructions:
Provide a playbook with cadence, metrics, evidence checklist, stakeholder roles, and reporting templates. Deliver in org/
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-045606-43185"
```
