...
Instructions:
Create a spec for forecasting storage and retention costs by data class, tenant, and retention policy. Include inputs, formulas, cadence, and example tables. Produce a concise deliverable for ops and finance.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-050521-76881"
```
