...
Instructions:
Create a one-page weekly digest template with KPI highlights, deltas, risks, wins, and next actions. Include layout guidance and sample placeholder copy in third-person verb voice.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-023603-73475"
```
