...
Instructions:
Create a concise kit: announcement templates, timing cadences, stakeholder mapping, FAQ, rollback messaging, and internal checklist. Write in third person verbs. Save output in the appropriate productralph run output file.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-023018-57350"
```
