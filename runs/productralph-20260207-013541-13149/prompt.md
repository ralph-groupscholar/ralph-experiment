...
Instructions:
Build a cost model for the Ralph Dashboard covering infra, storage, observability, and support. Include assumptions, variable drivers, and ways to optimize spend without reducing reliability.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-013541-13149"
```
