...
Instructions:
Produce a release checklist for trust center localization updates, covering translation review, legal/privacy checks, UI verification, and rollback criteria. Use third person verbs for public text.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-050458-75773"
```
