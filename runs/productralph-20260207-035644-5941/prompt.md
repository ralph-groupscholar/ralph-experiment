...
Instructions:
Define user flows, permissions, export formats, throttling UX, audit logging, and error states. Include wireframe descriptions and copy snippets. Output as markdown.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-035644-5941"
```
