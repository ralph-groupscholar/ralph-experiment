...
Instructions:
Draft a UX spec for an incident command center in Ralph Dashboard: key dashboards, triage panes, ownership handoffs, notification controls, and audit trail. Include primary flows, data model needs, permissions, and success metrics.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-042945-83121"
```
