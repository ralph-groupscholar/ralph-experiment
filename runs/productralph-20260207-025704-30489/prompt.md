...
Instructions:
Create a spec for a schema change impact simulation tool: inputs, dependency graph, risk scoring, report outputs, approvals, and integration with change requests. Keep public text in third person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-025704-30489"
```
