...
Instructions:
Create a plan for telemetry cost budgeting: data volume assumptions, retention tiers, sampling strategy, cost alerts, and monthly review cadence. Provide a 1-page policy plus an appendix of levers.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-024214-89199"
```
