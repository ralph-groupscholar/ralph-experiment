...
Instructions:
Create a concise runbook: alert severity tiers, triage decision tree, ownership/RACI, required evidence, rollback/mitigation steps, comms templates, and post-incident review checklist. Output as a markdown doc with headings and checklists.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-052948-51894"
```
