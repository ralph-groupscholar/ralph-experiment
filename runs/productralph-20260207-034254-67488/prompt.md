...
Instructions:
Create a framework that defines KPI hierarchy, metric-to-KPI mapping, ownership roles, data source dependencies, review cadence, and change control. Provide a template and example entries for Ralph Dashboard.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-034254-67488"
```
