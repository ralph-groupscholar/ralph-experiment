...
Instructions:
Create a playbook to optimize archival storage costs: data tiering rules, retention thresholds, deletion and legal hold coordination, monitoring KPIs, quarterly review checklist, and comms plan; include risk controls and decision matrix.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-030319-53024"
```
