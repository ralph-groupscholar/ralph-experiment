...
Instructions:
Create a concise SLA matrix for vulnerability remediation across severities, include timelines, ownership, and customer comms triggers. Deliver as a markdown doc in org/ with a clear title and table.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-031753-91911"
```
