...
Instructions:
Define controls for usage-based billing, metering accuracy, revenue recognition timing, exception handling, audit evidence, and month-end close steps. Include roles and sign-offs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-034256-67625"
```
