...
Instructions:
Produce a concise UX spec for saved views, pinned filters, and default view selection in Ralph Dashboard. Include user stories, settings locations, edge cases, audit logging expectations, and accessibility notes.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-040017-15330"
```
