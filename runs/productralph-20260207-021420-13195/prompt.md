...
Instructions:
Create a practical SOP for documenting data provenance and lineage updates. Include triggers, roles, artifacts, review cadence, and audit evidence checklist. Write in third person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-021420-13195"
```
