...
Instructions:
Create a concise guide covering developer portal IA, auth setup, API key creation, environment selection (sandbox/prod), quickstart flow, and troubleshooting checklist. Use GroupScholar tone; third person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-031136-74833"
```
