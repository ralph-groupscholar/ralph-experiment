...
Instructions:
Create a 6-session curriculum for district data literacy office hours, with objectives, agendas, exercises, and handouts list. Keep it actionable and ready for delivery. Save in runs/ timestamped folder.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-025903-35884"
```
