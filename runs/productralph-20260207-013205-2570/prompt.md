...
Instructions:
Spawn one CodeRalph with repo path '.' and branch 'productralph-smoke-20260207', then report the spawn id in the run output.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-013205-2570"
```
