...
Instructions:
Create a parent consent kit for district AI acceptable use including consent letter, FAQ, opt-out process, and translated message placeholders. Keep language in third person verbs per org rules.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-035405-98348"
```
