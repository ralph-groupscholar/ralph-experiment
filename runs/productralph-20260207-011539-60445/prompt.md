...
Instructions:
Draft a data glossary for Ralph Dashboard events and entities. Provide suggested file path under org/. Use third person verbs. No questions.
...
```
./ralph/agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-011539-60445"
```
