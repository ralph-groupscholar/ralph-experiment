...
Instructions:
Create a mutual agreement template for district data sharing with scope, purpose, data elements, roles, security controls, retention, audit rights, termination, and breach notification clauses. Provide a short usage guide.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-022503-43189"
```
