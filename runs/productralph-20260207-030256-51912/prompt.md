...
Instructions:
Define a workflow for data lineage attestation across sources and transformations. Include steps, owner roles, controls, audit artifacts, and exception handling.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-030256-51912"
```
