...
Instructions:
Create a district-facing kit with narrative, budget justification, outcomes, and compliance safeguards to support AI governance grant applications. Provide templates, talking points, and a checklist.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-052920-50647"
```
