...
Instructions:
Define required fields, governance workflow, ownership, validation rules, audit evidence, and UI/UX components for a data provenance registry inside the dashboard. Include integration points with lineage, catalog, and access controls.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-033338-42280"
```
