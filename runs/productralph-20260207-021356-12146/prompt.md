...
Instructions:
Build a template for a monthly adoption report covering activation, engagement, feature usage, cohort retention, support drivers, and next-month actions. Include metrics definitions and a one-page executive summary structure.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-021356-12146"
```
