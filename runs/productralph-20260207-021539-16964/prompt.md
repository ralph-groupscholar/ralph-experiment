...
Instructions:
Produce a structured assumptions sheet for TCO: staffing, infrastructure, support, training, licensing, and change management. Include example ranges and notes, third-person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-021539-16964"
```
