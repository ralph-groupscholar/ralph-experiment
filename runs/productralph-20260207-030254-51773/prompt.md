...
Instructions:
Create a survey instrument for district leaders to assess AI readiness. Include sections, question bank with response scales, scoring guidance, and reporting summary template.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-030254-51773"
```
