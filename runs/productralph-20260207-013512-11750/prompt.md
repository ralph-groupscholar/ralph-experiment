...
Instructions:
Draft an observability plan for Ralph Dashboard data pipelines: instrumentation points, key metrics, SLOs, and escalation paths. Provide a concise deliverable in third-person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-013512-11750"
```
