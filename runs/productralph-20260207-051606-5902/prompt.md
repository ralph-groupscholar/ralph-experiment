...
Instructions:
Draft a checklist and briefing kit for school board AI procurement approvals. Include agenda, decision criteria, required evidence, risk/benefit framing, public comment handling, and vote recordkeeping.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-051606-5902"
```
