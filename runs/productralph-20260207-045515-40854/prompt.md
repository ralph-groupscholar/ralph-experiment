...
Instructions:
Produce a UX spec for a permission change simulator that previews access impact before changes go live. Include user stories, data inputs/outputs, preview diff UI, guardrails, and audit logging.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-045515-40854"
```
