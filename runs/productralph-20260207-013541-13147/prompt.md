...
Instructions:
Define reliability objectives for the Ralph Dashboard: availability targets, latency targets, error budgets, alert thresholds, and monitoring coverage. Provide a table of SLOs and recommended telemetry.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-013541-13147"
```
