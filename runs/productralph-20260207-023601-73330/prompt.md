...
Instructions:
Produce a survey instrument for district onboarding with sections, question text, response scales, and a scoring rubric that maps to readiness tiers. Include a short admin guide.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-023601-73330"
```
