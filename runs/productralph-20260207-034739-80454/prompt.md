...
Instructions:
Create UI copy for data reconciliation exceptions: empty states, error states, validation messages, tooltips, and call-to-action labels. Provide concise variants and a glossary. Save outputs in the standard ProductRalph output location.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-034739-80454"
```
