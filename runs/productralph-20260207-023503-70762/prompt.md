...
Instructions:
Create a worksheet template with sections for hypothesis, scope, impacted KPIs, data sources, timestamps, severity, remediation, and follow-up. Keep language third person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-023503-70762"
```
