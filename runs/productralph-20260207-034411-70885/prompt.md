...
Instructions:
Create a checklist covering data export scope, timeline, evidence of deletion, subprocessor notifications, contract clauses, and communications plan. Include RACI and verification steps. Save output under org/ for BigRalph review.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-034411-70885"
```
