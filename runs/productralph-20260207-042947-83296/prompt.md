...
Instructions:
Draft a district-level playbook for rolling out AI classroom tools: stakeholder alignment, teacher training, policy guardrails, pilot evaluation, comms, and metrics. Deliver a structured outline plus checklists and a 90-day timeline.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-042947-83296"
```
