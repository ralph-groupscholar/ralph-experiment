...
Instructions:
Create a district-friendly DPA clause library for Ralph Dashboard: data sharing, retention, breach notice, subprocessors, FERPA/COPPA alignment, audit rights, data return/destruction. Provide clauses + negotiation notes.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-021224-7142"
```
