...
Instructions:
Produce a template that lists services, owners, backup owners, on-call rotation structure, escalation paths, and paging rules. Include a weekly update checklist and a lightweight governance cadence. Save as a markdown template in org/.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-030820-66441"
```
