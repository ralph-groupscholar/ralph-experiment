...
Instructions:
Define a narrative insights module that converts KPI changes into concise storycards. Include user goals, card types, empty states, copy guidelines, and success metrics.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-022851-53032"
```
