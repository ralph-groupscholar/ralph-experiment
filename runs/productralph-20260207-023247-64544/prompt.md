...
Instructions:
Draft a dependency and data flow map template for Ralph Dashboard incidents. Include upstream/downstream systems, data pipelines, ownership, criticality, and rollback notes. Provide a one-page template plus a short usage guide.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-023247-64544"
```
