...
Instructions:
Draft a test plan that validates de-identification controls and assesses re-identification risk. Include threat scenarios, metrics, sampling strategy, tooling, acceptance thresholds, and remediation workflow.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-034536-74900"
```
