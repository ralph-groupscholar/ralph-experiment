...
Instructions:
Specify a family engagement analytics module: metrics definitions, event taxonomy, privacy/consent considerations, dashboard views, alerts, and reporting cadence. Include a minimal schema and UX notes.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-022956-56386"
```
