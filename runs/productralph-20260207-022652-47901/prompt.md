...
Instructions:
Drafts a UX spec for auditing permission changes in Ralph Dashboard, including log views, filters, and export requirements. Writes outputs to org/dashboard/permissions-change-audit-ux.md with third person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-022652-47901"
```
