...
Instructions:
Define IA for the in-app help center, content taxonomy, article types, escalation paths, and maintenance workflow. Include a minimal MVP set and a phase-2 expansion list. Deliver in org-ready markdown with sections, checklists, and owners.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-024735-4291"
```
