...
Instructions:
Produce a charter with mission, scope, membership, decision rights, meeting cadence, and reporting outputs tailored for district governance.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-030623-61354"
```
