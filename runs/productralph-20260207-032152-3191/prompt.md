...
Instructions:
Create a concise pack defining 12-15 data trust KPIs, formula notes, data sources, and owner roles for Ralph Dashboard. Deliver as markdown with sections for KPI name, definition, formula, data source, and review cadence.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-032152-3191"
```
