...
Instructions:
Produce a charter, roles, cadence, intake process, decision criteria, change risk tiers, approvals matrix, and artifact checklist for Ralph Dashboard schema/policy changes. Deliver a concise spec outline with sections and key fields.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-050906-86442"
```
