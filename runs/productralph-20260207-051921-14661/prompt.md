...
Instructions:
Create a spec for a policy change impact simulation tool in Ralph Dashboard. Include goals, inputs, scenarios, UI flow, simulation logic, risk scoring, audit logging, and exportable reports. Provide acceptance criteria and open questions.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-051921-14661"
```
