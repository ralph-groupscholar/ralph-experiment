...
Instructions:
Create a SIS/LMS partner onboarding kit: technical prerequisites, data mapping worksheet, security/privacy checklist, sandbox access steps, sample timeline, and a communication plan for vendor contacts.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-020312-81608"
```
