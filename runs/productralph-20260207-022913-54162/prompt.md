...
Instructions:
Create a detailed spec for monitoring data latency and freshness in the Ralph Dashboard, including metrics, thresholds, alerting, dashboards, and operational responses. Use third-person verbs in public text.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-022913-54162"
```
