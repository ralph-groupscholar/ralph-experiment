...
Instructions:
Build a 12-month district stakeholder communications calendar for Ralph Dashboard: audiences, cadence, channels, key messages, owner, and KPIs. Include back-to-school and testing seasons.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-021226-7277"
```
