...
Instructions:
Create a playbook covering detection, triage, containment, communication, remediation, and post-incident review for evidence tampering events; include RACI, timelines, and artifacts.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-050936-87812"
```
