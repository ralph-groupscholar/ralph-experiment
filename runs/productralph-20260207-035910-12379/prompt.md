...
Instructions:
Create a template for a 3-year district data governance roadmap. Include phases, milestones, dependency map, staffing assumptions, budget buckets, risk register tie-ins, and quarterly review cadence. Provide guidance notes and sample entries.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-035910-12379"
```
