...
Instructions:
Draft a product spec for tracking SBOMs, dependency risk status, and evidence attachments inside the Ralph Dashboard. Include data model, UI flows, alerts, and compliance reporting outputs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-050428-74412"
```
