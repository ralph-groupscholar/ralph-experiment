...
Instructions:
Produce a concise spec for cross-team incident evidence handoff: roles, required artifacts, chain-of-custody steps, timestamps, storage locations, escalation triggers, and QA checklist. Keep third-person verbs in public text.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-052744-46234"
```
