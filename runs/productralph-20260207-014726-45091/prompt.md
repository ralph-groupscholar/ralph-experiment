...
Instructions:
Draft a gameday/incident simulation playbook for the Ralph Dashboard, including scenario catalog, roles, timelines, success criteria, and debrief template. Store outputs in org/dashboard/.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-014726-45091"
```
