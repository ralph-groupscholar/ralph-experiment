...
Instructions:
Provide a maturity model with 5 levels, scoring rubric, evidence indicators, and recommended next-step actions. Include a summary table and a worksheet section.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-034220-65407"
```
