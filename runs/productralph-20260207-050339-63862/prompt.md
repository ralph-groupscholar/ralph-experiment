...
Instructions:
Define a registry spec to document approved data uses, purpose limitation constraints, enforcement checks, and reporting dashboards. Include data model, workflows, and governance roles. Use third person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-050339-63862"
```
