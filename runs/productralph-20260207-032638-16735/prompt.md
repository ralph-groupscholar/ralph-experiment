...
Instructions:
Draft a spec for automating quarterly access recertification in Ralph Dashboard. Include system triggers, approval workflow, evidence capture, audit log schema, notifications, and failure handling. Provide sample UI copy and success metrics.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-032638-16735"
```
