...
Instructions:
Write a spec for an external change log API that partners can use to track schema changes and release events. Include endpoints, payloads, auth, versioning, and example responses. Output in markdown for org/dashboard use.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-025400-22180"
```
