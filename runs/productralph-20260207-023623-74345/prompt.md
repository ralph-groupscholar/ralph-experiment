...
Instructions:
Produce SOP for anonymizing sandbox/demo data, including scope, roles, step-by-step process, tooling, approvals, QA checks, and audit logging. Provide a template section and checklist.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-023623-74345"
```
