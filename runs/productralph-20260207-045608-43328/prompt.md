...
Instructions:
Outline UX for tracking regulatory changes, impact assessment, alerts, filters, and workflows. Deliver in org/
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-045608-43328"
```
