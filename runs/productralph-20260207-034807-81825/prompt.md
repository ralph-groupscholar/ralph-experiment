...
Instructions:
Create a structured interview guide: objectives, role-based question banks, maturity signals, red flags, and synthesis template. Provide as markdown with checklists and a 60-minute agenda.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-034807-81825"
```
