...
Instructions:
Develop a scorecard and readiness rubric for Ralph Dashboard failover drills. Include scoring dimensions, evidence artifacts, pass/fail thresholds, remediation tracking, and quarterly review cadence. Write in third person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-035035-88390"
```
