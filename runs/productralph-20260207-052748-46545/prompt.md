...
Instructions:
Define a lightweight sensitivity model for evidence retention costs: variables, ranges, scenarios, and reporting format. Include guidance for district tiers. Keep third-person verbs in public text.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-052748-46545"
```
