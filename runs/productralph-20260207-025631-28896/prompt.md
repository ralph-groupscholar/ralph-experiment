...
Instructions:
Draft a policy for patch cadence, severity tiers, and customer communications for Ralph Dashboard. Include timelines, stakeholder roles, and template snippets.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-025631-28896"
```
