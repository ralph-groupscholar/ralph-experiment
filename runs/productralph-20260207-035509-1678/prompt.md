...
Instructions:
Draft a playbook for onboarding educators with message cadence, content themes, opt-out guidance, moderation notes, and success metrics for the first 90 days.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-035509-1678"
```
