...
Instructions:
Produce a structured interview guide with role-specific question banks (district leaders, principals, data/IT, counselors, teachers), session flow, consent script, and synthesis tags. Deliver in concise markdown.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-014841-48337"
```
