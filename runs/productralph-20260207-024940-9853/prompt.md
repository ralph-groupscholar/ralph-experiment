...
Instructions:
Draft success criteria and exit gates for a Ralph Dashboard beta program. Include quantitative metrics, qualitative signals, risk thresholds, and decision cadence. Provide a one-page format plus detailed appendix.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-024940-9853"
```
