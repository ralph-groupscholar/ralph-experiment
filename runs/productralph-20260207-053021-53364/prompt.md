...
Instructions:
Create a spec for detecting model inventory drift, triggering review workflows, and logging approvals. Include data sources, detection logic, alerting, escalation, audit evidence, and UI requirements for reviewers.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-053021-53364"
```
