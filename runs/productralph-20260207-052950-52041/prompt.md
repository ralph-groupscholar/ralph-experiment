...
Instructions:
Produce an onboarding playbook: first-30/60/90-day plan, role expectations, meeting cadence, glossary, policy stack overview, training modules, and readiness checklist. Deliver as markdown with templates.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-052950-52041"
```
