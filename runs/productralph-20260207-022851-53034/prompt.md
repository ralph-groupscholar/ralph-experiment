...
Instructions:
Create a 90-minute workshop plan with objectives, agenda, pre-reads, activities, and outputs. Focus on data sharing, governance, and dashboard rollout alignment.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-022851-53034"
```
