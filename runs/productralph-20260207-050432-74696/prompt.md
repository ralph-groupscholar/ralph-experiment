...
Instructions:
Define a UX spec for a timeline view that shows consent grant, renewal, revocation, and audit events, with filters and exportable evidence.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-050432-74696"
```
