...
Instructions:
Define an API spec that exposes model cards, usage transparency logs, and decision explanations to authorized district admins. Include endpoints, auth scopes, response schema, and rate limits.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-050525-77190"
```
