...
Instructions:
Produce a governance charter covering decision rights, escalation paths, review cadences, and change control for the Ralph Dashboard.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-013953-24676"
```
