...
Instructions:
Produce a concise plan and checklist for control effectiveness testing for the Ralph Dashboard. Include cadence, sampling approach, evidence types, mapping to controls, ownership, and reporting outputs. Write in third person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-051052-91167"
```
