...
Instructions:
Define identity verification steps, MFA requirements, recovery flows, exceptions process, and audit logging expectations.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-030624-61460"
```
