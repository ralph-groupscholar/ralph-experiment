...
Instructions:
Create a spec for how Ralph Dashboard tracks user/data consent across districts and products. Include data model, workflows, audit logging, UI surfaces, and reporting. Output as a markdown doc under org/
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-021444-14319"
```
