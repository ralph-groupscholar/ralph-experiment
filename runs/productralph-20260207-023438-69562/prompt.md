...
Instructions:
Create an outline for a district implementation kickoff deck for GroupScholar. Include objectives, roles, timeline, data readiness, security, governance, success metrics, and next steps. Provide slide titles and speaker notes.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-023438-69562"
```
