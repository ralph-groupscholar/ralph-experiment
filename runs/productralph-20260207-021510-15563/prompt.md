...
Instructions:
Create a scorecard template with definitions, calculation notes, and review cadence for data governance metrics used in district deployments.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-021510-15563"
```
