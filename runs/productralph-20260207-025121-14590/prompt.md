...
Instructions:
Define KPIs, data model, dashboard views, alerts, and operational cadence. Provide a minimal schema and sample report outputs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-025121-14590"
```
