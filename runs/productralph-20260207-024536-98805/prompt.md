...
Instructions:
Produce a GroupScholar district value realization roadmap for the first 180 days post-launch. Include phases, milestones, owner roles, artifact checklist, and measurement plan. Deliver in third person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-024536-98805"
```
