...
Instructions:
Inspect org docs in /Users/ralph/setup/org and existing dashboard notes in the repo. Propose a concise module list and initial layout for the Ralph Dashboard MVP. Deliver a short, actionable summary.
...
```
./ralph/agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-010654-37178"
```
