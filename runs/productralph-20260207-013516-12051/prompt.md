...
Instructions:
Draft executive narrative templates for the Ralph Dashboard: weekly business review, monthly ops review, and incident summary narratives. Provide a concise deliverable in third-person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-013516-12051"
```
