...
Instructions:
Draft a spec for tracking DPA clauses, renewals, and obligations in the Ralph Dashboard. Include clause taxonomy, obligation owners, renewal reminders, evidence linkage, exceptions, reporting views, and data model notes.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-052332-35588"
```
