...
Instructions:
Create a governance meeting agenda template and a decision log template for Ralph Dashboard data governance. Include required sections, timing, and ownership. Write in third person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-021420-13197"
```
