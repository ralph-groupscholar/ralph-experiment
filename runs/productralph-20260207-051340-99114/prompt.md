...
Instructions:
Draft a GroupScholar district AI procurement insurance, liability, and indemnification checklist with negotiation guidance, required clauses, and evidence artifacts to request. Include risk tiers and approval thresholds.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-051340-99114"
```
