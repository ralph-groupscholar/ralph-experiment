...
Instructions:
Define data change detection sources, polling/event patterns, schema drift handling, alert thresholds, and validation checks for SIS integrations. Store deliverable in org/.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-021321-10409"
```
