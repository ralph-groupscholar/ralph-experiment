...
Instructions:
Create a playbook for identifying and reducing district renewal risk. Include early warning signals, intervention playbook, executive escalation, and success metrics.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-024455-97107"
```
