...
Instructions:
Draft a privacy-by-design checklist aligned to FERPA/COPPA for Ralph Dashboard; include data collection limits, consent flows, access controls, retention, and audit requirements.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-020507-87059"
```
