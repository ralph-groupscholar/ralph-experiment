...
Instructions:
Produce a Ralph Dashboard permissions justification memo template for audit readiness. Include sections, required evidence, approval routing, retention guidance, and example language. Deliver in third person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-024538-98966"
```
