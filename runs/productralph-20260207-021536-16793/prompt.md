...
Instructions:
Create a one-page executive brief for district leaders that summarizes data governance posture, key controls, and benefits. Keep it concise, third-person verbs, and include a short metrics callout section.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-021536-16793"
```
