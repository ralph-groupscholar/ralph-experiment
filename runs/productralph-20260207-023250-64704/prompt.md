...
Instructions:
Create a scoring rubric for vendor security questionnaires for GroupScholar. Include categories, scoring scale, required evidence, red flags, and go/no-go thresholds. Deliver as a concise rubric plus an example filled scorecard.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-023250-64704"
```
