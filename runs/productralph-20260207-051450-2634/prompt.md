...
Instructions:
Produce a maturity assessment rubric for district data governance. Include domains, levels 1-5 definitions, scoring guidance, evidence examples, and a 90-day improvement plan template. Save in org/ with facilitation notes.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-051450-2634"
```
