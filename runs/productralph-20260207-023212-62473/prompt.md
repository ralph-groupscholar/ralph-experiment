...
Instructions:
Draft a district data steward role competency matrix with proficiency levels, behaviors, required artifacts, and a training path. Include onboarding milestones and evaluation cadence. Use third‑person verbs throughout.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-023212-62473"
```
