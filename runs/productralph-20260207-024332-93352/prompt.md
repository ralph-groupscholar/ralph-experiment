...
Instructions:
Produce UI microcopy for lineage views: empty states, filters, tooltips, and error messages. Keep third person verbs, concise.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-024332-93352"
```
