...
Instructions:
Draft a purpose-binding verification spec for data access and processing in the Ralph Dashboard, including control objectives, enforcement points, audit evidence, and exception handling.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-052849-49325"
```
