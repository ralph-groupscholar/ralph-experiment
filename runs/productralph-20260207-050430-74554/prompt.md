...
Instructions:
Produce a checklist and SOP for retiring AI models in districts, including data retention, audit artifacts, stakeholder comms, and validation steps.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-050430-74554"
```
