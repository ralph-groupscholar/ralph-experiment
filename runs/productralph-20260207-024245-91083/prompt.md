...
Instructions:
Create a structured risk register focused on district data sharing for Ralph Dashboard. Include risk statement, likelihood, impact, early warning signals, mitigations, owners, and review cadence. Keep it concise and action-ready.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-024245-91083"
```
