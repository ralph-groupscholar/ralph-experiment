...
Instructions:
Draft a subprocessor registry template, a subprocessor change notice template, and an approval workflow for new subprocessors. Use third person verbs throughout. Keep it concise and district-facing.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-022226-35227"
```
