...
Instructions:
Draft a step-by-step SOP for verifying data purge and deletion requests, including system-of-record checks, backup purge handling, log evidence, and customer confirmation language.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-023058-59194"
```
