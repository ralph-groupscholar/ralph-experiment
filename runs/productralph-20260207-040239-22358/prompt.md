...
Instructions:
Create a playbook for quarterly governance metrics review: agenda, roles, prework checklist, data pack outline, decision log, and follow-up actions. Deliver in org/ with templates and facilitation guidance.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-040239-22358"
```
