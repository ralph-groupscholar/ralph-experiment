...
Instructions:
Draft an anomaly detection spec for Ralph Dashboard data quality and usage signals; include detection categories, thresholds, alert routing, suppression rules, and example incidents.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-020505-86922"
```
