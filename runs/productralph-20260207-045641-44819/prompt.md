...
Instructions:
Draft a customer-facing data integrity attestation disclosure template for the Ralph Dashboard. Include purpose, scope, methodology summary, limitations, and renewal cadence. Deliver in org/ as markdown.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-045641-44819"
```
