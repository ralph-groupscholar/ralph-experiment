...
Instructions:
Deliver a UX spec for an AI explainability panel inside Ralph Dashboard. Include user stories, IA, key screens, data requirements, copy guidance, telemetry, and accessibility considerations. Keep tone third person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-042836-80205"
```
