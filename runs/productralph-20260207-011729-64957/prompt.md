...
Instructions:
Draft a data quality playbook for the Ralph Dashboard: checks, ownership, monitoring cadence, escalation, and tooling. Provide concise bullets suitable for org documentation. Use third person verbs in all public text.
...
```
./ralph/agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-011729-64957"
```
