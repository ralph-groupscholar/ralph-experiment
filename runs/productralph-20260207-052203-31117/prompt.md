...
Instructions:
Produce a remediation kit: triggers, playbooks, comms templates, RCA outline, corrective actions, and dashboard widgets. Save output in the standard productralph output path.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-052203-31117"
```
