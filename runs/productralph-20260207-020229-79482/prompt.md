...
Instructions:
Produce a checklist for external data sharing agreements: scope, purpose, legal basis, security controls, data minimization, retention, and breach handling. Write in third-person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-020229-79482"
```
