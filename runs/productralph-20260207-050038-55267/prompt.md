...
Instructions:
Draft an operating model for GroupScholar trust center governance. Include roles, decision rights, change control stages, evidence intake cadence, publication SLAs, and escalation paths. Deliver as a concise governance guide with tables.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-050038-55267"
```
