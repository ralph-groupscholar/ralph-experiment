...
Instructions:
Produce a structured template for comparing AI vendors: capabilities, data governance, security/privacy, cost, implementation risk, equity impact, and references; include scoring rubric and summary page.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-050938-87988"
```
