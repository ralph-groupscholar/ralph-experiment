...
Instructions:
Create a spec for automating evidence capture, storage, and audit-ready packaging for Ralph Dashboard compliance artifacts. Include scope, data sources, pipeline stages, controls, retention, access, audit trails, and a delivery roadmap.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-032315-7617"
```
