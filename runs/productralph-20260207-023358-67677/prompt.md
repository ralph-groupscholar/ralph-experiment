...
Instructions:
Define a Ralph Dashboard consent audit schedule and procedures. Include cadence, scope, sampling methodology, artifacts, escalation path, and reporting format. Use third person verbs in all public text.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-023358-67677"
```
