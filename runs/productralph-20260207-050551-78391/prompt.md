...
Instructions:
Define an annual calendar for vendor risk reviews: triggers, tiers, evidence requirements, and sign-off matrix. Include a sample schedule table and escalation rules.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-050551-78391"
```
