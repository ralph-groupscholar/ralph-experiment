...
Instructions:
Draft a QA checklist to reconcile customer data exports against source systems. Include pre-export validation, sampling strategy, reconciliation steps, discrepancy classification, remediation workflow, and evidence capture requirements.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-033925-57736"
```
