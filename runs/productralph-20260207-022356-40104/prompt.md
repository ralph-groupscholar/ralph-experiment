...
Instructions:
Create a structured template for mapping district data systems to Ralph Dashboard data flows, including fields, definitions, and usage guidance. Provide a versioned template in org/ with third-person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-022356-40104"
```
