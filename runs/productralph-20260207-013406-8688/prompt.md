...
Instructions:
Create a beta program plan: goals, target cohorts, recruiting criteria, onboarding steps, success metrics, feedback loops, and timeline. Produce concise doc with sections and action checklist.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-013406-8688"
```
