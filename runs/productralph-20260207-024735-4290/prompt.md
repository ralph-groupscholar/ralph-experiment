...
Instructions:
Define SLA credit tiers, eligibility rules, calculation formulas, exclusions, notification workflow, and customer comms template. Provide a simple calculator table with examples and implementation notes.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-024735-4290"
```
