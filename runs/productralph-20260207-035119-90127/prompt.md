...
Instructions:
Draft an internal KPI dashboard spec for district data governance operations. Include KPI definitions, data sources, refresh cadence, owners, thresholds, and a wireframe-style layout description. Write in third person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-035119-90127"
```
