...
Instructions:
Define a district data sharing consent revocation workflow, including triggers, approvals, timelines, system actions, communications, and audit logging. Use third-person verbs in public text.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-022913-54161"
```
