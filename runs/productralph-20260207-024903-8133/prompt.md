...
Instructions:
Create a 12-month PD plan with modules, learning objectives, delivery formats, role-based tracks, and measurement. Include pacing, artifacts, and adoption KPIs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-024903-8133"
```
