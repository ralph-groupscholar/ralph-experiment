...
Instructions:
Create a GroupScholar annual review checklist for district data sharing agreements. Include compliance, security, data minimization, purpose alignment, access review, retention, and incident lessons learned. Keep tone third-person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-022811-51492"
```
