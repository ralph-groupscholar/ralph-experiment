...
Instructions:
Provide a guide to run a quarterly district data storytelling showcase: goals, selection criteria, prep timeline, coaching script, slide template outline, and judging rubric. Save in runs/ with timestamped folder.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-025905-36023"
```
