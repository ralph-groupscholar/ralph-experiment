...
Instructions:
Create a quarterly review pack: agenda, scorecard, KPI definitions, evidence checklist, stakeholder roles, escalation thresholds, and summary narrative template.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-052805-47381"
```
