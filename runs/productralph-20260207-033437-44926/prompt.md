...
Instructions:
Design a survey instrument to benchmark district data governance KPIs across peers. Include sections, question types, scoring guidance, and a data privacy note. Deliver a ready-to-use questionnaire with a short analysis plan.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-033437-44926"
```
