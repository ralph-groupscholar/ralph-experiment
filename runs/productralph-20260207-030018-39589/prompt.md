...
Instructions:
Create a playbook defining signals, thresholds, owners, response plays, and escalation. Include a weekly review checklist and a 30-60-90 recovery plan outline. Use third person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-030018-39589"
```
