...
Instructions:
Draft a district-facing training pack for staff readiness before AI rollout. Include learning objectives, session outlines, facilitator notes, assessment rubric, and a 30/60/90-day reinforcement plan.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-053056-54926"
```
