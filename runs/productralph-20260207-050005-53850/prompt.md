...
Instructions:
Draft a mentorship program for district data governance: roles, cadence, curriculum tracks, matching criteria, success metrics, and sample outreach copy.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-050005-53850"
```
