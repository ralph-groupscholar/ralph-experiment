...
Instructions:
Create a rubric for district data governance risks with scoring dimensions, thresholds, and mitigation guidance. Provide a Markdown rubric table and a brief usage guide.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-025603-27753"
```
