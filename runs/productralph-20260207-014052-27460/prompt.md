...
Instructions:
Create a feature prioritization matrix for the Ralph Dashboard (impact vs effort) including top 12 candidate features, rationale, and recommended sequencing. Use third person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-014052-27460"
```
