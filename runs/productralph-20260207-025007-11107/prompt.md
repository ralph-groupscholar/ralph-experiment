...
Instructions:
Create a QA test plan for district data integrations covering SIS, LMS, and assessment feeds. Include test data strategy, validation checks, error handling, performance tests, security tests, and sign-off criteria.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-025007-11107"
```
