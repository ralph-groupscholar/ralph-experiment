...
Instructions:
Deliver a concise spec for a KPI dashboard that tracks district data requests: metrics list, data sources, definitions, thresholds, sample views, and implementation notes. Write in third person verbs, no questions.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-022030-29988"
```
