...
Instructions:
Draft a workflow and approval rubric for partner API key requests, including intake form fields, risk checks, least-privilege scopes, expiration/rotation policy, and decision log template.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-023100-59330"
```
