...
Instructions:
Drafts a sustainability and carbon footprint reporting spec for the Ralph Dashboard, covering metrics, data sources, calculation methodology, reporting cadence, and stakeholder views.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-050807-84026"
```
