...
Instructions:
Draft an SEO plan for the GroupScholar website including keyword themes, content clusters, technical SEO checklist, and schema.org markup recommendations. Provide a 90-day execution roadmap and success metrics. Use third person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-032227-4893"
```
