...
Instructions:
Produce a spec for a consent-change impact simulation workbook: inputs, formulas, scenario library, output charts, QA checks, and governance approvals.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-052807-47516"
```
