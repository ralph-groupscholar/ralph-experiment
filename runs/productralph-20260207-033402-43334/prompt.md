...
Instructions:
Provide a concise spec covering triggers, safeguards, approval flow, rollout/rollback steps, observability signals, and acceptance criteria. Keep public text in third person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-033402-43334"
```
