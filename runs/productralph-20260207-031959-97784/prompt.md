...
Instructions:
Produce a layout/grid standard for Ralph Dashboard: breakpoints, column grids, spacing rules, page templates, density modes, and responsive behavior for key modules. Include examples and rationale. Write in third person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-031959-97784"
```
