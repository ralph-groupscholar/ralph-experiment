...
Instructions:
Create a security review checklist covering access controls, data handling, audit logs, secrets, network boundaries, threat modeling, and sign-off criteria. Keep it actionable and concise.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-013411-9006"
```
