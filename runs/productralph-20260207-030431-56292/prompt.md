...
Instructions:
Create a schedule template for quarterly incident simulations plus an after-action tracker with fields, severity tags, and follow-up SLAs. Include facilitator notes and participant roles. Use third-person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-030431-56292"
```
