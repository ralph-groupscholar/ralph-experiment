...
Instructions:
Inventory data in runs/ and state/; propose collector scripts, outputs, and schedules; keep concise.
...
```
./ralph/agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-010809-40600"
```
