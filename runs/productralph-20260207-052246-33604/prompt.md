...
Instructions:
Draft a spec for an evidence request intake SLA calculator. Define inputs, assumptions, UI elements, calculations, edge cases, and output formats. Use third person verbs in public text. Place output in org/ with a clear filename.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-052246-33604"
```
