...
Instructions:
Create a playbook defining data quality KPI thresholds, alert severity mapping, and remediation steps. Include examples for freshness, completeness, accuracy, and duplication. Deliver as concise sections and tables.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-021254-9268"
```
