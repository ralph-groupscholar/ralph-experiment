...
Instructions:
Define event lifecycle states, versioning, deprecation notice periods, consumer migration steps, and enforcement gates. Include sample communications template. Use third person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-030016-39457"
```
