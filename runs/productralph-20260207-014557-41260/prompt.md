...
Instructions:
Define event/metric instrumentation guidance: naming conventions, required properties, PII handling, validation rules, and versioning strategy. Deliver markdown suitable for org/ dashboard.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-014557-41260"
```
