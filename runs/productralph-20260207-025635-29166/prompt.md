...
Instructions:
Draft an onboarding checklist for district legal counsel reviewing Ralph Dashboard: key documents, approval steps, risk questions, and decision timeline guidance.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-025635-29166"
```
