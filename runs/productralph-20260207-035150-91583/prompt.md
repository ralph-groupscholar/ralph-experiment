...
Instructions:
Draft a 6-email onboarding sequence for district data governance leaders. Include subject lines, goals, timing (day offsets), and CTAs. Keep tone formal and concise. Provide placeholders for district name, sponsor name, and timeline.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-035150-91583"
```
