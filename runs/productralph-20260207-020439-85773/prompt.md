...
Instructions:
Draft an implementation guide for partner data exchange: data exchange modes, security checklist, field mapping steps, testing/validation, and go-live checklist. Store output in org/ with clear filenames. Use third-person verb phrasing.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-020439-85773"
```
