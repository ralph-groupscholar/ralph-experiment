...
Instructions:
Create an agenda and facilitation guide for a district parent AI safety info night. Include objectives, segment timing, demo flow, Q{{INSTRUCTIONS}}A prompts, and follow-up resources. Keep public copy in third person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-045512-40671"
```
