...
Instructions:
Draft a spec that maps Ralph Dashboard features to SKUs/tiers, includes entitlement rules, exceptions, trial/grace logic, and admin UI implications. Provide a matrix table, definitions, and implementation notes for billing/ops/CS.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-031446-83726"
```
