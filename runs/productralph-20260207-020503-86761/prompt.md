...
Instructions:
Draft an interoperability mapping for Ralph Dashboard with Ed-Fi, OneRoster, and CSV/SFTP feeds; include data entities, sync directions, frequency options, and known constraints; deliver as a concise spec with a mapping table.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-020503-86761"
```
