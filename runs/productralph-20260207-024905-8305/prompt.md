...
Instructions:
Define charter, membership, intake workflow, review criteria, meeting cadence, decision records, escalation paths, and transparency reporting. Include templates and sample agenda.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-024905-8305"
```
