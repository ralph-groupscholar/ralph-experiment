...
Instructions:
Produce a spec for a Ralph Dashboard feature that auto-generates a field-level data access matrix across roles and datasets. Include inputs, rules engine, exports, UI surfaces, and audit hooks. Keep tone third-person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-022806-51151"
```
