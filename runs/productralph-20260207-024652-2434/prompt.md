...
Instructions:
Write a charter defining objectives, scope, red-team scenarios, data handling rules, reporting cadence, severity rubric, remediation workflow, and stakeholder roles. Include a 90-day launch plan.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-024652-2434"
```
