...
Instructions:
Draft a release train calendar template with deployment windows, freeze periods, and a comms checklist. Include roles, timelines, and rollback checkpoints. Keep all public text in third person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-025325-20436"
```
