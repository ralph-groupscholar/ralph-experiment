...
Instructions:
Produce a draft microsite copy: hero, value pillars, onboarding steps, governance roles, FAQs, and CTA blocks. Keep tone third person verbs. Save output in the appropriate productralph run output file.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-023020-57486"
```
