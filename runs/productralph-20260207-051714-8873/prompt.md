...
Instructions:
Draft a spec that defines domain ownership boundaries, data product contracts, stewardship roles, lifecycle gates, and escalation paths for the Ralph Dashboard data mesh. Include artifacts, roles, cadences, and a rollout plan.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-051714-8873"
```
