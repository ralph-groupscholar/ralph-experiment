...
Instructions:
Draft a spec for a Ralph Dashboard module that tracks policy exceptions, trendlines, root-cause tagging, and remediation velocity. Include core metrics, data model fields, UX layout, alerts, and governance workflow.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-051751-10485"
```
