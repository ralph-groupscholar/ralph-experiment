...
Instructions:
Produce a concise architecture overview: key services, data flow, integration points, and deployment topology. Keep it implementation-agnostic but actionable for planning.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-013927-23373"
```
