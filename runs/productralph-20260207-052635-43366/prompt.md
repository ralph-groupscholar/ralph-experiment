...
Instructions:
Define a report that reconciles declared lineage vs observed lineage across systems. Include inputs, matching logic, confidence scoring, exception taxonomy, UI/report sections, and export formats.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-052635-43366"
```
