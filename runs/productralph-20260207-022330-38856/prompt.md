...
Instructions:
Create a concise, district-friendly data escrow and exit plan for Ralph Dashboard. Include triggers, escrow contents, verification cadence, and step-by-step exit data export, retention, and deletion sequence. Deliver as a ready-to-paste doc.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-022330-38856"
```
