...
Instructions:
Draft a cost model and calculator template for estimating incident impact (engineering, support, customer churn risk, legal/compliance, and SLA credits) with assumptions table and usage guidance.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-030844-67513"
```
