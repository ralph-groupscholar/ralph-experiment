...
Instructions:
Draft a partnership pipeline playbook: lead sources, qualification rubric, partner tiers, evaluation steps, due diligence checklist, negotiation guardrails, and post-signing onboarding workflow. Keep third-person verbs in public text.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-020807-95271"
```
