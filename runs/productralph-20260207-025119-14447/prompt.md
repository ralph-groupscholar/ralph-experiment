...
Instructions:
Produce an SOP for approval stages, roles, SLAs, exception handling, audit trail, and communications templates. Deliver a concise markdown doc with a flow diagram in ASCII.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-025119-14447"
```
