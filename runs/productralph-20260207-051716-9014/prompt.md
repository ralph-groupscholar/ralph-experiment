...
Instructions:
Create a student/parent/educator co-design workshop kit for AI procurement, including agenda, facilitation guide, activities, consent handling, capture templates, and synthesis rubric.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-051716-9014"
```
