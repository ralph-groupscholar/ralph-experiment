...
Instructions:
Create a step-by-step guide and template outline for calculating incentive budgets tied to governance adoption. Include inputs, formulas, example scenarios, and stewardship metrics. Use third-person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-033622-49561"
```
