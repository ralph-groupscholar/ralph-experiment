...
Instructions:
Create a practical checklist and timeline for district AI initiatives that require staff or union consultation. Include triggers, required artifacts, meeting agendas, and communication templates.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-051530-4265"
```
