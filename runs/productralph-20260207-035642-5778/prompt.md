...
Instructions:
Create a KPI pack with definitions, data sources, targets, and reporting cadence for first 180 days. Provide executive summary and dashboards layout suggestions. Output as markdown.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-035642-5778"
```
