...
Instructions:
Produce a concise service catalog template with fields, tier definitions, and usage guidance for dashboard operations.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-030457-57535"
```
