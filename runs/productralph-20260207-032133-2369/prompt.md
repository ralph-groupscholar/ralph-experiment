...
Instructions:
Produce a reliability reporting pack: monthly scorecard template, SLO compliance narrative, incident highlights, and action tracker. Include a sample filled-in month.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-032133-2369"
```
