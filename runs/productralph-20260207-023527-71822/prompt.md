...
Instructions:
Create a narrative template for district KPI reporting: sections, prompts, exemplar placeholders, and guidance on data storytelling with cautions.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-023527-71822"
```
