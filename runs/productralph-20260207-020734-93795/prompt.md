...
Instructions:
Draft a board update brief for the Ralph Dashboard: progress, risks, next 30/60/90 days, and asks. Keep it one page, third person verbs, and reference GroupScholar context.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-020734-93795"
```
