...
Instructions:
Draft a spec for calculating cost impact of privacy incidents, including direct, indirect, remediation, legal, and reputational components. Provide inputs, formulas, and reporting layout.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-032614-15717"
```
