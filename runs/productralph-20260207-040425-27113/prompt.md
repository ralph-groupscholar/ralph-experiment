...
Instructions:
Draft a 12-month staffing plan for district data governance. Include role sequence, hiring milestones, capacity assumptions, onboarding and training rubric, and a budget range framework. Provide a phased org chart narrative.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-040425-27113"
```
