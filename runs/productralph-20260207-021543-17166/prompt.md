...
Instructions:
Create an outline for an integration test harness covering SIS connectors, API contracts, data quality checks, and regression scenarios. Provide sections, responsibilities, and sample test cases. Third-person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-021543-17166"
```
