...
Instructions:
Draft a playbook for monitoring, alerting, investigation, and response for data loss prevention events in Ralph Slack. Include detection sources, triage steps, severity mapping, comms templates, and post-incident review checklist.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-035153-91776"
```
