...
Instructions:
Produce a spec for scoring data sharing agreement clauses by risk (legal, privacy, security, operational). Include scoring rubric, weights, examples, and remediation guidance. Output in org/ with clear sections and templates.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-051530-4264"
```
