...
Instructions:
Draft a Ralph Dashboard data residency and localization policy covering regions, storage locations, replication, access, and customer commitments. Deliver a concise policy doc with assumptions and open risks.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-013818-20183"
```
