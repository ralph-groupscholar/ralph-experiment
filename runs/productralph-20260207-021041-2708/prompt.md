...
Instructions:
Create a Ralph Dashboard support ticket taxonomy with categories, severity levels, ownership, response targets, and escalation triggers. Include a routing matrix and example ticket tags. Output as concise markdown tables.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-021041-2708"
```
