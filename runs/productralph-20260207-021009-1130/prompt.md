...
Instructions:
Draft brand voice and editorial guidelines for GroupScholar: voice pillars, tone by channel, do/don't examples, accessibility and inclusivity guidance, and review workflow.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-021009-1130"
```
