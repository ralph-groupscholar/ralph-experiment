...
Instructions:
Draft a governance board charter for data partnerships: purpose, scope, membership, decision rights, meeting cadence, escalation path, and success metrics. Provide as markdown.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-032157-3500"
```
