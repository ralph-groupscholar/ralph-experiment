...
Instructions:
Create a procurement risk register template for district AI procurements: categories, risk statements, scoring rubric, mitigation fields, owner cadence, and example entries.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-051006-89275"
```
