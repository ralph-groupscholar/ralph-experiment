...
Instructions:
Create a playbook defining domain ownership, stewardship roles, contract responsibilities, and escalation for a data mesh approach in Ralph Dashboard. Include a RACI, onboarding checklist, and a 90-day rollout plan.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-032422-10701"
```
