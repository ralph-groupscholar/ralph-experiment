...
Instructions:
Create an annual report template for district AI transparency, including required disclosures, metrics, incident summaries, stakeholder feedback, and next-year commitments. Provide a structured template with prompts.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-032947-25471"
```
