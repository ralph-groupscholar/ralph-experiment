...
Instructions:
Define purpose, scope, membership, decision rights, meeting cadence, escalation paths, and success metrics. Include a lightweight charter template and a 90-day rollout plan.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-024133-87332"
```
