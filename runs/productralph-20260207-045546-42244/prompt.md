...
Instructions:
Create a toolkit for rolling out district AI changes. Include audience segmentation, timeline, channel plan, message pillars, templates for staff/family/board, FAQ seeds, and feedback loops.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-045546-42244"
```
