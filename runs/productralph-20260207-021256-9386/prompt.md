...
Instructions:
Create a win themes and objection handling library for GroupScholar and Ralph Dashboard. Include top themes, proof points, and responses to common district IT, data privacy, and procurement objections.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-021256-9386"
```
