...
Instructions:
Define a test suite spec for data masking across pipelines and exports, including test cases, fixtures, automated checks, failure triage, and evidence artifacts. Include sample acceptance criteria. Write in third person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-031917-95818"
```
