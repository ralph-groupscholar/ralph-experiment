...
Instructions:
Build a model/spec to quantify incident impact (data scope, student-days affected, service downtime, regulatory exposure, reputational impact). Include formulas, tiers, and reporting templates.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-051530-4266"
```
