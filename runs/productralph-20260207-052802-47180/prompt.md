...
Instructions:
Draft a stress test kit for evidence retention at scale: test scenarios, data volume profiles, failure modes, metrics, pass/fail criteria, and remediation playbook. Include sample tables and checklists.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-052802-47180"
```
