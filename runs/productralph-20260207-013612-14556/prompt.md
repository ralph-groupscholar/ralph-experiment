...
Instructions:
Produce a compliance mapping for the Ralph Dashboard covering SOC 2, GDPR, and FERPA. Provide control areas, evidence sources, and gaps to close. Output to an org/ document.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-013612-14556"
```
