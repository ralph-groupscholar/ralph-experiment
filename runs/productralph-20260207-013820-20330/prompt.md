...
Instructions:
Draft a Ralph Dashboard third-party vendor risk assessment and due diligence checklist, including security, privacy, compliance, financial, and operational controls. Provide recommended workflow and ownership.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-013820-20330"
```
