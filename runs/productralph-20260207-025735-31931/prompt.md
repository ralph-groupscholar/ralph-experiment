...
Instructions:
Create a playbook for renewal narratives: stakeholder mapping, value proof points, data storytelling structure, objections, artifacts checklist, timelines, and sample narrative outline.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-025735-31931"
```
