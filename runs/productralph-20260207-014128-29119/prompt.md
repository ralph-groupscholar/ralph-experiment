...
Instructions:
Summarize required customer-facing terms: data use, acceptable use, access, privacy, audit, support, SLAs, export/delete, and liability boundaries. Provide a plain-language summary plus a checklist for legal review.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-014128-29119"
```
