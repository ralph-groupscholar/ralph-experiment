...
Instructions:
Create a reusable monthly newsletter template for district data governance community updates, including sections, tone guidance, subject line variants, and a sample issue outline.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-035235-94077"
```
