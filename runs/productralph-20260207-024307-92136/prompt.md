...
Instructions:
Create a concise briefing pack outline and content bullets for weekly exec review: top KPIs, risks, customer signals, roadmap, and action items. Use third-person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-024307-92136"
```
