...
Instructions:
Create standards for lineage visualization: node/edge semantics, level-of-detail rules, privacy masking, UX patterns, performance constraints, and export formats. Include accessibility and governance requirements and a review checklist.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-032731-19360"
```
