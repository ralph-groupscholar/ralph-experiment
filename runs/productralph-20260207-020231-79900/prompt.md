...
Instructions:
Deliver a role-based permission matrix with roles, allowed actions, data scopes, and approval gates. Include default roles for district admin, school admin, teacher, counselor, analyst. Write in third-person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-020231-79900"
```
