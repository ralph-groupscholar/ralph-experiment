...
Instructions:
Produce a UX spec for admin delegation and proxy access: personas, use cases, permission boundaries, UI flows, audit logs, copy, edge cases, and success metrics. Deliver a concise, structured markdown doc.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-040124-18311"
```
