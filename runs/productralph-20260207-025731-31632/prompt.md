...
Instructions:
Create a product spec for a change impact cost calculator: inputs, assumptions, formulas, UX flow, outputs, data sources, validation, and example scenarios. Deliver as a concise spec with tables and sections.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-025731-31632"
```
