...
Instructions:
Build a spreadsheet-style template spec with tabs, fields, and formulas for annual governance budget tracking, including staffing, tools, training, audits, and contingency.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-035536-2882"
```
