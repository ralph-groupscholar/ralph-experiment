...
Instructions:
Design a ROI calculator model for the dashboard. Define inputs, assumptions, calculation logic, and outputs, plus example scenarios for a small, mid, and large customer.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-014813-47162"
```
