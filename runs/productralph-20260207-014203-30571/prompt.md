...
Instructions:
Draft a service catalog for Ralph Dashboard, define service tiers, SLAs/SLOs, coverage hours, escalation paths, and success metrics. Output a concise, executive-ready doc with tables and assumptions.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-014203-30571"
```
