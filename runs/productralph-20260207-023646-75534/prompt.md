...
Instructions:
Define a 5-level maturity model for data observability in the Ralph Dashboard context. Include dimensions (freshness, quality, lineage, usage, alerting), level descriptions, indicators, and recommended next steps per level.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-023646-75534"
```
