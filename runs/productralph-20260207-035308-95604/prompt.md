...
Instructions:
Define a verification harness for data exports: checksums, row counts, schema validation, sampling, failure handling, audit logging, and automated reporting. Provide clear steps and acceptance criteria. Deliver in third-person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-035308-95604"
```
