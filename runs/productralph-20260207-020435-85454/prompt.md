...
Instructions:
Create a concise feature request intake kit: intake form fields, submission workflow, prioritization rubric, and response SLAs. Store output in org/ with clear filenames. Use third-person verb phrasing.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-020435-85454"
```
