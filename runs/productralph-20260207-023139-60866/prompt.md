...
Instructions:
Create a self-assessment checklist and scoring rubric covering SIS readiness, data standards alignment (Ed-Fi/OneRoster), SSO readiness, data governance, security prerequisites, and implementation timeline signals.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-023139-60866"
```
