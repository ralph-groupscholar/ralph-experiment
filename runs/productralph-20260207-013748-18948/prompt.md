...
Instructions:
Produce an on-call handbook for Ralph Dashboard: rotation model, escalation paths, severity definitions, runbook expectations, paging policy, and post-incident requirements. Deliver concise markdown for org docs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-013748-18948"
```
