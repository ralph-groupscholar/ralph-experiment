...
Instructions:
Write a short transparency statement for parents/guardians describing how Ralph Dashboard uses AI, data sources, safeguards, opt-out/consent pathways, and contact channels. Include a plain-language version and a formal version.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-022155-33918"
```
