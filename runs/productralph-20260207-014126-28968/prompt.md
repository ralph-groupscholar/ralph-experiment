...
Instructions:
Define voice, tone, terminology, error messages, empty states, tooltips, onboarding copy patterns, and banned phrasing. Provide examples and guardrails.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-014126-28968"
```
