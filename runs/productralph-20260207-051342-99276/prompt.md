...
Instructions:
Draft a Ralph Dashboard AI red-teaming program plan and findings intake tracker spec. Cover cadence, scope selection, roles, severity taxonomy, remediation workflow, evidence mapping, and reporting templates.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-051342-99276"
```
