...
Instructions:
Create a feedback program: channels, cadence, intake template, triage rules, and ownership. Output in org/projects or org/ as appropriate, third person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-013340-7486"
```
