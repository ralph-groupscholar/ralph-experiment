...
Instructions:
Create a strategy doc covering target locales, prioritization rubric, translation workflow, glossary management, QA checks, in-product language switch UX, release cadence, and owner/RACI. Deliver a concise outline plus key decisions and risks.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-024652-2432"
```
