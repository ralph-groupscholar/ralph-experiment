...
Instructions:
Write a UX spec for a change log viewer in the Ralph Dashboard. Include user stories, permissions, filters, retention, audit export, and wireframe descriptions.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-022729-49663"
```
