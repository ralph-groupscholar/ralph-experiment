...
Instructions:
Draft a competitive landscape summary for the Ralph Dashboard: key competitor categories, differentiation angles, and positioning notes. Provide a concise deliverable in third-person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-013510-11587"
```
