...
Instructions:
Create a concise training curriculum outline for district data access reviewers. Include modules, learning objectives, delivery format, time estimates, and required materials. Produce a facilitator guide outline plus assessment questions.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-024451-96798"
```
