...
Instructions:
Create internal/external launch comms plan with audiences, message map, timeline, assets, and approvals. Use third person verbs in public text.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-013342-7615"
```
