...
Instructions:
Draft an incident severity matrix (Sev 0-3) with response targets and communication rules, plus a postmortem template with required sections and sample entries. Keep it consistent with prior incident response playbook context.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-014208-30843"
```
