...
Instructions:
Draft a crisis communications template pack for school hours incidents in Ralph Slack. Include message templates for stakeholders, approval workflow, localization notes, and do-not-send guardrails.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-053056-54927"
```
