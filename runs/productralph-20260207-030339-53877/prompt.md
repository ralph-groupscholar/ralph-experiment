...
Instructions:
Create a practical cost-of-downtime calculator template with inputs, formulas, assumptions, and example scenario for district customers. Provide a one-pager summary plus a detailed worksheet structure.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-030339-53877"
```
