...
Instructions:
Create an SOP for handling public records requests tied to district data governance. Include intake channels, timelines, legal review checkpoints, redaction workflow, fee schedule guidance, audit logging, and communications templates.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-034533-74728"
```
