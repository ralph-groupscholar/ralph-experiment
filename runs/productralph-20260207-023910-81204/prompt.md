...
Instructions:
Draft a model for expansion readiness with signals, scoring rubric, data sources, playbook actions, and reporting cadence. Include a sample scorecard template. Save deliverable in org/ with clear filename.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-023910-81204"
```
