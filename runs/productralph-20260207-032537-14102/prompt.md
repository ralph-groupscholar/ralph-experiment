...
Instructions:
Draft a spec for an AI usage transparency ledger in Ralph Dashboard. Define scope, data model, audit log fields, retention, user-facing views, and export formats. Include compliance considerations and integration touchpoints.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-032537-14102"
```
