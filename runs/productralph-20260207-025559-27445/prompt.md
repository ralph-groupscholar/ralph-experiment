...
Instructions:
Create a detailed workflow with steps, roles, SLAs, audit requirements, and user-facing comms. Output a Markdown doc with sections for triggers, approval, data impacts, and logging.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-025559-27445"
```
