...
Instructions:
Draft an evaluation protocol for model explainability: objectives, methods, artifacts, review cadence, and acceptance criteria. Deliver as markdown doc in org/.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-031753-91913"
```
