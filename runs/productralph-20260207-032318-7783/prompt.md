...
Instructions:
Design a recurring pulse survey program for district stakeholders. Include survey cadence, audiences, sample questions, scoring, analysis plan, comms loops, and how insights drive governance updates.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-032318-7783"
```
