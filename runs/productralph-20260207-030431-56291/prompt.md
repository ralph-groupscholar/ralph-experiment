...
Instructions:
Write a narrative bank with 15 short, reusable briefing narratives tied to common district KPI outcomes. Include KPI name, narrative, caveats, and recommended next action. Use third-person verbs and concise language.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-030431-56291"
```
