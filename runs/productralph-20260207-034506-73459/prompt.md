...
Instructions:
Create a 1-day executive bootcamp agenda and materials outline for district data governance leaders. Include objectives, session flow, exercises, pre-reads, facilitation tips, and take-home artifacts. Focus on adoption, risk, and ROI.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-034506-73459"
```
