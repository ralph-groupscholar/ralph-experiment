...
Instructions:
Write a deployment topology decision brief comparing single-tenant, pooled multi-tenant, and hybrid options. Include tradeoffs for cost, isolation, compliance, and operational overhead, plus a recommendation matrix.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-014811-47025"
```
