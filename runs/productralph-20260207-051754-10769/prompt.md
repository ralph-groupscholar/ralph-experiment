...
Instructions:
Draft a spec that defines model risk tiers, approval gates, required evidence per tier, review cadence, and UI workflow for submissions, approvals, and audits.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-051754-10769"
```
