...
Instructions:
Create a survey kit for district pilot evaluations of AI procurement. Include stakeholder personas, survey sections, Likert scales, open-ended prompts, scoring rubric, and a synthesis template for board-ready reporting.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-051420-1081"
```
