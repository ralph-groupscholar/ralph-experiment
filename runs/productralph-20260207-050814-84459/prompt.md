...
Instructions:
Drafts a vendor sustainability scorecard and procurement checklist for the Ralph Dashboard, covering supplier data center energy mix, emissions reporting, and contract evidence requirements.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-050814-84459"
```
