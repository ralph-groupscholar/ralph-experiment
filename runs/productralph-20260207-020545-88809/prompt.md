...
Instructions:
Create a support escalation matrix with severity, response targets, internal owners, and triage steps. Include handoff criteria to engineering and customer success. Save output under org/ and note filename in response.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-020545-88809"
```
