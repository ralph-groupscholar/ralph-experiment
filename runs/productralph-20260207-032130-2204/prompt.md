...
Instructions:
Build a 6-week district data governance training syllabus: weekly objectives, lesson plan, exercises, artifacts, and evaluation rubric. Provide a facilitator checklist and participant homework.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-032130-2204"
```
