...
Instructions:
Draft customer-facing status page content guidelines, incident update templates, component list, and an SLA mapping that ties status states to credits and communications. Keep tone professional and concise.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-032352-9395"
```
