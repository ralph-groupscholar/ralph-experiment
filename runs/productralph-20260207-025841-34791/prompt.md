...
Instructions:
Draft a quick-start kit for district data governance adoption. Include 30/60/90-day plan, stakeholder roles, meeting cadence, minimal artifacts, and early wins. Keep third-person, action-oriented language.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-025841-34791"
```
