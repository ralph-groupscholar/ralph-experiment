...
Instructions:
Produce an operational runbook for secrets management and key rotation for the Ralph Dashboard. Cover roles, key types, rotation cadence, emergency rotation, monitoring, evidence logging, and exception handling. Write in third person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-051052-91169"
```
