...
Instructions:
Create a 5-touch outreach email sequence for district leaders introducing GroupScholar and the Ralph Dashboard. Include subject lines, core message, and CTA per email.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-021615-18634"
```
