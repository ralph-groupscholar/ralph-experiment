...
Instructions:
Produce a data quality scoring model and rubric for Ralph Dashboard datasets. Define dimensions, scoring scales, weighting, calculation method, and thresholds for action. Include examples and how scores map to remediation workflows.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-022549-45138"
```
