...
Instructions:
Create a checklist that covers legal, security, data mapping, integration testing, access controls, privacy notices, and go-live readiness. Provide step-by-step tasks with owners and evidence artifacts.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-032805-20850"
```
