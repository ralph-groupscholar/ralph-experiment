...
Instructions:
Define a canonical analytics event taxonomy for Ralph Dashboard. Include naming conventions, required properties, user/org context, privacy guardrails, versioning, and examples for core product flows.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-025005-10946"
```
