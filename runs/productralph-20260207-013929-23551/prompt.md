...
Instructions:
Define monitoring coverage, alert tiers, ownership routing, and dashboards for reliability. Include metrics list and escalation policy outline.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-013929-23551"
```
