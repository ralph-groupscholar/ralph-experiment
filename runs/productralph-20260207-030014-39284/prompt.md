...
Instructions:
Produce a severity taxonomy (SEV0-4), triggers, ownership, response timelines, comms requirements, and rollback criteria. Provide a one-page matrix plus a short SOP summary. Use third person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-030014-39284"
```
