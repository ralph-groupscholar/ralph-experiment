...
Instructions:
Define a portable evidence bundle format for audits and customer requests. Include packaging structure, metadata manifest, hashing/signing, export workflow, permissions, and verification steps. Provide sample file tree and manifest fields.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-051609-6076"
```
