...
Instructions:
Produce criteria for pilot partner selection (data readiness, leadership buy-in, tech stack fit, equity considerations), a weighted scorecard rubric, and success metrics for 30/60/90 days. Save output under org/ and note filename in response.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-020541-88494"
```
