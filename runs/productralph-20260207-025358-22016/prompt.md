...
Instructions:
Produce a partner program tiering and benefits matrix for GroupScholar. Cover tiers, eligibility, benefits, obligations, and review cadence. Output as a concise markdown doc ready for org/ references.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-025358-22016"
```
