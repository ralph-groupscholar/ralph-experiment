...
Instructions:
Create a markdown template for assessing impacts of data model, source, and policy changes. Include sections for affected stakeholders, data lineage, reporting impacts, remediation steps, approvals, and communication plan.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-022625-46713"
```
