...
Instructions:
Create a template with sections for risk categories, tolerance bands, escalation thresholds, and review cadence. Use third person verbs for public text.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-033403-43467"
```
