...
Instructions:
Draft an automation spec for quarterly access reviews: data sources, reviewer workflow, exception handling, evidence capture, and audit-ready export format.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-030848-67821"
```
