...
Instructions:
Outline 12-month budget forecast with headcount, tooling, infra, and contingency; include hiring timeline and cost drivers.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-014257-33900"
```
