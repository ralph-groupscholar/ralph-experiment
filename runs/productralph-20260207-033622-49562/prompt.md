...
Instructions:
Define scorecard dimensions, data sources, scoring model, reporting cadence, and escalation thresholds for vendor SLAs. Provide a template structure. Use third-person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-033622-49562"
```
