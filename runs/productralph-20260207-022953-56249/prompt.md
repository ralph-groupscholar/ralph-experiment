...
Instructions:
Define an early warning indicators (EWI) playbook: indicator selection criteria, data sources, risk scoring rubric, bias checks, thresholds, interventions menu, and monitoring cadence. Provide a template districts can adopt.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-022953-56249"
```
