...
Instructions:
Create a playbook covering pre-change rehearsal, dry-run steps, success criteria, rollback triggers, and post-change validation for data pipeline updates.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-030359-55030"
```
