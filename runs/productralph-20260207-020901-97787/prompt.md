...
Instructions:
Create a slide-by-slide outline with objectives, key messages, and required assets for a partner enablement deck. Use third person verbs in all public text. Save to org/skills or org/dashboard as appropriate.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-020901-97787"
```
