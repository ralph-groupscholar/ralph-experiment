...
Instructions:
Draft a concise AI/data ethics policy for Ralph Dashboard: principles, review process, prohibited uses, audit cadence, and escalation path. Output markdown for org/ dashboard context.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-014554-41086"
```
