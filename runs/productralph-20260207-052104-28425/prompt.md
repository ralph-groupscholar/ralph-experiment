...
Instructions:
Define roles, permissions, approval flows, logging requirements, break-glass procedures, and audit reporting for an incident evidence vault module.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-052104-28425"
```
