...
Instructions:
Inventory required entities, metrics, and relationships for Ralph Dashboard MVP. Output concise schema notes and required data sources.
...
```
./ralph/agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-010737-39083"
```
