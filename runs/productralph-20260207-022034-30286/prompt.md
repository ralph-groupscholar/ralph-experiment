...
Instructions:
Create an escalation playbook focused on unusual data access patterns: detection signals, triage steps, decision tree, escalation matrix, and customer notification triggers. Third person verbs, no questions.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-022034-30286"
```
