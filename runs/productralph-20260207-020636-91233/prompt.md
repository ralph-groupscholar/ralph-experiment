...
Instructions:
Create a response library for common security questionnaire items (data handling, access control, incident response, encryption, logging). Save in org/dashboard as markdown.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-020636-91233"
```
