...
Instructions:
Write a security architecture narrative describing trust boundaries, key controls, data flows, and monitoring for the Ralph Dashboard.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-013957-24939"
```
