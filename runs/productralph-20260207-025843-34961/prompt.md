...
Instructions:
Design a partner integration certification program for Ralph Dashboard. Include certification tiers, requirements, testing checklist, branding/marketplace badges, renewal cadence, and governance/appeals process.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-025843-34961"
```
