...
Instructions:
Produce an SOP for a district data ethics reporting hotline: intake channels, triage, confidentiality, escalation, response timelines, and communications templates.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-030339-53878"
```
