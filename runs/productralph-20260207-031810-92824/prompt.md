...
Instructions:
Produce a detailed model for scoring integration risk: inputs, scoring rubric, tier thresholds, evidence required, review cadence, escalation triggers, and customer-facing summary.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-031810-92824"
```
