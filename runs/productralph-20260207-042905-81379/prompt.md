...
Instructions:
Draft a UX spec for a Ralph Dashboard data contract registry. Include lifecycle states, ownership fields, approval workflow, search/filtering, and audit trail requirements. Provide key screens, interactions, and open questions.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-042905-81379"
```
