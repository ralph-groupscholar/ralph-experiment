...
Instructions:
Produce a matrix template for district data sharing risks with columns for risk, scenario, impact, likelihood, controls, owner, evidence, and residual rating. Include example entries tailored to K-12 data sharing.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-021354-12004"
```
