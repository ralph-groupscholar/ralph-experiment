...
Instructions:
Draft a privacy-by-design onboarding checklist for Ralph Slack deployments and an in-app consent UX copy pack (microcopy, prompts, and FAQs) aligned to district deployments.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-052416-37493"
```
