...
Instructions:
Write an SOP for detecting, triaging, communicating, and resolving data freshness exceptions, including owner roles, escalation thresholds, customer comms templates, and post-incident review steps.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-023139-60867"
```
