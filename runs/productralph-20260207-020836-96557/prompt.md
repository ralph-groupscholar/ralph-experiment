...
Instructions:
Define core metrics, event naming conventions, data collection points, QA checks, and dashboard rollup logic. Include governance on metric ownership and review cadence.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-020836-96557"
```
