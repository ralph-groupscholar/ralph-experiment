...
Instructions:
Drafts concise UI copy for AI explainability surfaces (tooltips, modals, settings) in Ralph Dashboard. Writes outputs to org/dashboard/ai-explainability-ui-copy-pack.md with third person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-022657-48209"
```
