...
Instructions:
Draft a spec covering intake, approval roles, risk scoring, quality gates, and audit evidence outputs for synthetic datasets used in Ralph Dashboard analytics. Include workflows, checklists, and audit trail fields.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-052916-50453"
```
