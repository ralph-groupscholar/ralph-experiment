...
Instructions:
Create a concise brief defining pilot success metrics, leading/lagging indicators, measurement cadence, data sources, and decision thresholds for expanding district pilots.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-021642-19721"
```
