...
Instructions:
Write a tuning guide for audit log anomaly detection in the Ralph Dashboard: signal definitions, baseline windows, false positive reduction techniques, escalation rules, and a quarterly review checklist.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-033019-26767"
```
