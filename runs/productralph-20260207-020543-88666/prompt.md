...
Instructions:
Provide a reusable template capturing baseline metrics, intervention, data-sharing costs, impact measures, and attribution guidance. Include evidence collection plan and sample prompts. Save output under org/ and note filename in response.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-020543-88666"
```
