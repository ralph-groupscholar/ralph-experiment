...
Instructions:
Define submission requirements, review criteria, security checks, documentation standards, support expectations, and approval timeline for third-party integrations.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-035235-94078"
```
