...
Instructions:
Draft a monthly executive scorecard template for the Ralph Dashboard. Include sections, metrics rollup, risks, decisions needed, and next-month focus. Use concise headings and placeholders.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-014642-43265"
```
