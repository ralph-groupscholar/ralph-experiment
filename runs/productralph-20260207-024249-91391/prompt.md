...
Instructions:
Create a plan for localization and multilingual support. Include supported locales, translation workflow, content ownership, QA checks, rollout phases, and metrics.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-024249-91391"
```
