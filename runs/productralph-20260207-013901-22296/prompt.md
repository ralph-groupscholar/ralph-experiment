...
Instructions:
Draft a data lineage and provenance map for the Ralph Dashboard. Identify source systems, transformations, storage layers, and consumer modules, plus ownership and validation points. Deliver a concise map in org/.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-013901-22296"
```
