...
Instructions:
Create a template and checklist for an annual AI vendor audit evidence binder for districts. Include sections, evidence types, owner roles, collection cadence, and approval flow. Deliver in org/ as markdown.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-045639-44676"
```
