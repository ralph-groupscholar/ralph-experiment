...
Instructions:
Create a district procurement timeline and milestone template for Ralph Dashboard including phases, typical durations, decision gates, required artifacts, and owner roles. Output as a clear checklist and timeline table ready for org use.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-021252-9118"
```
