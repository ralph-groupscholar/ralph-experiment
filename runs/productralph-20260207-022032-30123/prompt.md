...
Instructions:
Produce a joint incident response protocol for partner data exchanges: roles, escalation, comms, timelines, evidence sharing, and postmortem alignment. Third person verbs, no questions.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-022032-30123"
```
