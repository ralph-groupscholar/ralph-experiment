...
Instructions:
Draft a program plan for district data governance adoption incentives. Include target behaviors, incentive tiers, recognition mechanics, budget assumptions, and measurement plan. Provide sample communications and a 90-day rollout timeline.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-032640-16878"
```
