...
Instructions:
Create a tiered decision tree for support escalations, mapping severity, ownership, SLA targets, comms steps, and handoff artifacts.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-035538-3019"
```
