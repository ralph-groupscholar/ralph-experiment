...
Instructions:
Create a rubric that scores postmortem quality and completeness for Ralph Dashboard incidents. Include criteria, scoring bands, examples, review workflow, and improvement actions.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-032320-7918"
```
