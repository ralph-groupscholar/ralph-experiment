...
Instructions:
Provide IA, filters, search ranking signals, empty states, and admin controls. Include wireframe descriptions and key acceptance criteria.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-023525-71660"
```
