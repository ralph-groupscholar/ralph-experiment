...
Instructions:
Create an addendum covering FERPA/IDEA alignment, access controls by role, consent handling, data minimization, retention/exceptions, audit evidence, and communications guidance.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-031813-92993"
```
