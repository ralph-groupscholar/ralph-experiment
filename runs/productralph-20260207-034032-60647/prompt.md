...
Instructions:
Produce a detailed checklist for onboarding new vendors into district data governance programs. Include legal, privacy, security, data minimization, data sharing, and lifecycle controls. Output as a standalone markdown doc.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-034032-60647"
```
