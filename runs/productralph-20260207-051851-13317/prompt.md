...
Instructions:
Draft a parent-facing AI usage transparency dashboard kit for districts: KPI list, data definitions, privacy safeguards, copy blocks, and FAQ. Include rollout checklist and comms snippets.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-051851-13317"
```
