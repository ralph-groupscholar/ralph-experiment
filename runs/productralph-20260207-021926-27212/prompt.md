...
Instructions:
Map district personas to roles, permissions, and data access boundaries; include least-privilege rationale, onboarding steps, and change-request workflow.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-021926-27212"
```
