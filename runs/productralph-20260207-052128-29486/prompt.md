...
Instructions:
Create an annual report template with sections, data tables, narrative guidance, and evidence checklist. Include public-facing third-person voice and compliance citations placeholders.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-052128-29486"
```
