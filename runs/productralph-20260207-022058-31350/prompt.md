...
Instructions:
Create a Ralph Dashboard district data governance KPI glossary and definitions. Provide a markdown doc with 20-30 KPIs, definitions, calculation notes, owner, and reporting cadence. Keep language exec-ready.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-022058-31350"
```
