...
Instructions:
Create a checklist for ingesting district academic calendar data into Ralph Dashboard: data fields, validation rules, edge cases, seasonal updates, and sign-off steps.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-023623-74368"
```
