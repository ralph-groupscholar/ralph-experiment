...
Instructions:
Define data freshness SLAs and staleness UX for the Ralph Dashboard. Include freshness tiers, default thresholds, alerting triggers, user-facing messaging, and escalation paths. Provide in markdown with a short rationale.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-014455-38538"
```
