...
Instructions:
Create a spec for monitoring third-party access, anomaly detection, alert thresholds, escalation flow, evidence artifacts, and reporting. Provide data model fields, UI modules, and operational runbook notes.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-052125-29352"
```
