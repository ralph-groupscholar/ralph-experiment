...
Instructions:
Create a calendar template and operating guide for quarterly incident communications drills, including audience, channels, escalation, and after-action steps.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-031658-89394"
```
