...
Instructions:
Produce a concise brief defining benchmarking goals, peer cohort selection, normalization rules, statistical safeguards, sample size thresholds, privacy considerations, and how the dashboard should present comparisons with disclaimers.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-023139-60865"
```
