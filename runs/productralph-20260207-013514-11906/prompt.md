...
Instructions:
Draft a change management and training rollout plan for Ralph Dashboard adoption: stakeholder map, training cadence, enablement assets, and reinforcement loops. Provide a concise deliverable in third-person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-013514-11906"
```
