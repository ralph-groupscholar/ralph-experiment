...
Instructions:
Define a spec for generating exec-ready narratives from dashboard data. Include input schema, narrative templates, tone controls, governance, review workflow, and export formats.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-045720-46527"
```
