...
Instructions:
Create an SOP for escalation ladder and duty roster: roles, triggers, severity levels, response times, communication channels, handoffs, and cadence. Provide templates and checklists in markdown.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-040126-18484"
```
