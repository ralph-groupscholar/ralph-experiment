...
Instructions:
Create a concise workflow covering intake, ownership assignment, stewardship duties, review cadence, escalation, and audit checkpoints. Deliver a structured outline with sections, roles, SLAs, and artifacts.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-023558-73169"
```
