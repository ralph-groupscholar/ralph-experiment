...
Instructions:
Produce a synthetic data generation guide for demos and QA. Cover data domains, distribution rules, edge cases, privacy constraints, and reset scripts. Include a sample dataset spec and risk notes.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-014809-46876"
```
