...
Instructions:
Build a board-ready FAQ focused on procurement, legal, privacy, and compliance objections. Provide concise responses, evidence artifacts list, and escalation paths. Keep tone in third person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-024735-4292"
```
