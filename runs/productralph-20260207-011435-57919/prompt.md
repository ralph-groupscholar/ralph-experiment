...
Instructions:
Define onboarding flow, key user roles, and first-week success metrics for Ralph Dashboard. Provide a short checklist and ownership map.
...
```
./ralph/agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-011435-57919"
```
