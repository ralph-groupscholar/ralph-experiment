...
Instructions:
Map key SOC 2 Trust Services Criteria to Ralph Dashboard operational artifacts (policies, logs, runbooks). Deliver a quick-reference table plus owner notes. Write in third-person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-022304-37757"
```
