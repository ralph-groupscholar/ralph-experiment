...
Instructions:
Draft a student safety escalation routing matrix for Ralph Slack. Include severity tiers, time-to-ack targets, roles, notification channels, audit logging, and escalation flow. Keep public text in third person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-035801-9378"
```
