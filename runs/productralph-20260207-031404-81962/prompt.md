...
Instructions:
Produce a one-pager spec for a calculator that estimates storage/compute costs by retention tier, includes inputs/outputs, formulas, assumptions, and a sample scenario.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-031404-81962"
```
