...
Instructions:
Create a clause guide for AI procurement change orders and scope creep guardrails for districts. Include clause options, triggers, approval thresholds, pricing adjustments, and audit rights. Write in third person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-051052-91168"
```
