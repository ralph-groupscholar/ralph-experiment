...
Instructions:
Create a readiness scorecard for district onboarding to Ralph Dashboard, with scoring rubric, required artifacts, and decision gates.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-020659-92264"
```
