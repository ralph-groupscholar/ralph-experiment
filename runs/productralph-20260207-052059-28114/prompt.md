...
Instructions:
Create a concise roadmap covering phases, key milestones, dependencies, and success metrics for automating evidence retention in the Ralph Dashboard. Include risk register and open questions.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-052059-28114"
```
