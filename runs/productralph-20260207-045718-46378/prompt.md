...
Instructions:
Create a workshop kit for families to understand district AI use. Include agenda, facilitator script, slides outline, FAQ, take-home handout, and feedback form.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-045718-46378"
```
