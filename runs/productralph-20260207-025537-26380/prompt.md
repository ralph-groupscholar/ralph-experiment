...
Instructions:
Create a reusable meeting minutes template for the Ralph Dashboard change advisory board. Include attendance, agenda, change decisions, risk notes, approvals, and follow-ups. Save output as a new markdown file under org/ with a clear name.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-025537-26380"
```
