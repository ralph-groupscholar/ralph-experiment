...
Instructions:
Create a rubric and certification pathway for district data governance training. Include levels, competencies, assessment methods, recertification cadence, and evidence requirements. Provide a one-page summary plus detailed rubric tables.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-032350-9252"
```
