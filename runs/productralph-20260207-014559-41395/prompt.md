...
Instructions:
Create a one-page executive briefing template for Ralph Dashboard: objectives, health snapshot, risks, decisions needed, next milestones. Use third-person verbs and concise bullet structure.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-014559-41395"
```
