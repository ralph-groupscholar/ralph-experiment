...
Instructions:
Draft a customer advisory board charter: purpose, membership criteria, cadence, agenda template, feedback intake, and success metrics. Store output in org/ with clear filenames. Use third-person verb phrasing.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-020437-85590"
```
