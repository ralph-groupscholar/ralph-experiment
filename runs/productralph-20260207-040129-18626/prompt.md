...
Instructions:
Write a playbook for detecting and alerting on data contract breaches: monitoring signals, thresholds, triage steps, notification templates, remediation paths, and KPIs. Output a structured markdown guide.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-040129-18626"
```
