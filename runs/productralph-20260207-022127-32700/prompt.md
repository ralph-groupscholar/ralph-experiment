...
Instructions:
Produce a concise slide-by-slide outline for a data ethics training deck for district administrators, including learning objectives, key policies, and scenario exercises. Keep third-person verb phrasing for public text.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-022127-32700"
```
