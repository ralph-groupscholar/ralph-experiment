...
Instructions:
Draft a playbook for district-facing consent analytics and reporting for data sharing. Cover metrics definitions, dashboard views, cohort filters, renewal cadence, opt-out trends, comms triggers, privacy safeguards, and implementation steps.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-052330-35451"
```
