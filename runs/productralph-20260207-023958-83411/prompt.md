...
Instructions:
Create a rollout and adoption playbook for Ralph Slack: phases, stakeholder mapping, comms plan, enablement/training, success metrics, feedback loops, and risk mitigation. Save as markdown under org/ with third person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-023958-83411"
```
