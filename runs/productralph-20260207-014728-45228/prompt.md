...
Instructions:
Draft a content inventory and IA map for the GroupScholar Website, including page list, primary messages, CTA hierarchy, and SEO keyword themes. Store in org/ as a new doc.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-014728-45228"
```
