...
Instructions:
Create a risk register template tailored to district implementations. Include risk categories, likelihood/impact scoring, early warning indicators, owner roles, mitigation playbooks, and review cadence. Provide a filled example for 3 risks.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-032535-13950"
```
