...
Instructions:
Create a playbook covering triggers, timelines, customer comms templates, legal review checkpoints, and escalation steps for vendor/subprocessor changes.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-030621-61180"
```
