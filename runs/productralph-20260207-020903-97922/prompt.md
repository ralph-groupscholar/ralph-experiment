...
Instructions:
List control families, evidence artifacts, owners, and collection cadence for a SOC 2-ready checklist. Use third person verbs in all public text. Save to org/dashboard or org/skills.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-020903-97922"
```
