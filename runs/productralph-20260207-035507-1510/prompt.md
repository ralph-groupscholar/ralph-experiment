...
Instructions:
Create a scoring rubric for district AI procurement covering privacy, equity, safety, pedagogy, data governance, cost, vendor viability, and implementation readiness. Include scoring bands, evidence checklist, and decision thresholds.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-035507-1510"
```
