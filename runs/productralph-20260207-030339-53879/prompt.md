...
Instructions:
Build a playbook for cohort-based adoption analysis: cohort definitions, retention curves, activation milestones, segmentation, and reporting cadence.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-030339-53879"
```
