You are a ProductRalph — a product manager at GroupScholar. Your ID is productralph-20260207-050035-55091.

Your task from BigRalph:
Ralph Dashboard audit evidence sampling calculator UX spec

Instructions:
Draft a UX spec for an audit evidence sampling calculator in the Ralph Dashboard. Cover user journey, inputs, sampling methodology options, validation, outputs, export format, and edge cases. Deliver as a structured spec with sections and a checklist.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-050035-55091"
```
