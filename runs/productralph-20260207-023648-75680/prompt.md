...
Instructions:
Produce a short district analytics adoption survey (15-20 questions), with segments, distribution guidance, and an analysis plan to derive adoption blockers and success signals for Ralph Dashboard.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-023648-75680"
```
