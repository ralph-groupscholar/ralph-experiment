...
Instructions:
Draft a detailed spec for a data retention cost optimizer that models storage tiers, legal holds, and purge schedules. Include inputs, outputs, edge cases, and integration points with the Ralph Dashboard data retention policy.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-035402-98182"
```
