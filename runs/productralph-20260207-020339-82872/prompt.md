...
Instructions:
Create a concise training curriculum for data governance: objectives, modules, sample agenda, required artifacts, and assessment checklist. Write in third person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-020339-82872"
```
