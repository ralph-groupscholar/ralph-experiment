...
Instructions:
Define a scoring model to prioritize evidence requests (impact, regulatory deadline, customer tier, incident severity, data criticality). Provide scoring rubric, weighting, triage SLA tiers, and automation triggers.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-050911-86786"
```
