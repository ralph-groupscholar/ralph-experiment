...
Instructions:
Draft a plan for tracking district stakeholder sentiment (superintendent, principals, teachers, families). Include data sources, cadence, KPIs, governance, privacy constraints, and a lightweight reporting template.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-024938-9681"
```
