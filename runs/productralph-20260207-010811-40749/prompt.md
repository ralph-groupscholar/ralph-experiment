...
Instructions:
Draft module API schema for dashboard tiles and summary endpoints; note fields, sample payloads, and refresh rules.
...
```
./ralph/agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-010811-40749"
```
