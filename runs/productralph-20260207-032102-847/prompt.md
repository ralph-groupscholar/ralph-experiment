...
Instructions:
Create an ADR outlining lakehouse vs warehouse for Ralph Dashboard analytics. Include context, decision, alternatives, consequences, data governance impacts, and phased migration plan. Keep it crisp and decision-ready.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-032102-847"
```
