...
Instructions:
Create a user research plan for the Ralph Dashboard: target personas, research questions, methods, recruitment criteria, sample sizes, session scripts, analysis framework, and how insights feed the roadmap.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-013641-15969"
```
