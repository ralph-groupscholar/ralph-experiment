...
Instructions:
Create a concise spec for an approval workflow covering stakeholders, steps, SLAs, escalation, audit logging, and UI states. Deliver in org/
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-045604-43041"
```
