...
Instructions:
Create a toolkit with templates, checklists, and facilitation guide for district AI impact assessments, including stakeholder interview prompts, risk scoring, and reporting format. Use third person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-050339-63861"
```
