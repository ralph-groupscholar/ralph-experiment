...
Instructions:
Draft a data validation rules catalog: rule categories, examples, severity levels, ownership, and escalation. Include a template table and guidance for ongoing maintenance.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-014843-48474"
```
