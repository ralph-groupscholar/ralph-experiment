...
Instructions:
Create a playbook for assessing SIS vendor upgrades: dependency mapping, data contract changes, regression checklist, stakeholder impact matrix, rollout windows, and a communications kit (admin, IT, teachers).
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-031851-94722"
```
