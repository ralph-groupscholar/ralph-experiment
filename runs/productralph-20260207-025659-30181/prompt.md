...
Instructions:
Create a concise requirements doc plus UX spec for a self-service data subject request portal (FERPA/COPPA aligned). Include roles, workflows, data fields, SLAs, audit logging, and security controls. Keep public text in third person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-025659-30181"
```
