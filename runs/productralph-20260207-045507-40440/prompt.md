...
Instructions:
Draft a practical plan for automated accessibility testing in CI for the Ralph Dashboard. Include tooling options, smoke vs. full scans, PR gating rules, failure triage workflow, and a phased rollout timeline.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-045507-40440"
```
