...
Instructions:
Produce an SOP for districts covering intake criteria, legal/consent checks, data minimization, de-identification, approval workflow, documentation templates, review cadence, audit artifacts, and roles/RACI. Include checklist and timeline.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-035842-11065"
```
