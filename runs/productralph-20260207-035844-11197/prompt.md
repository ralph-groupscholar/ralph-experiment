...
Instructions:
Draft a test plan with objectives, threat model assumptions, test cases, telemetry validation, data set setup, automation hooks, pass/fail criteria, and reporting template for cross-tenant isolation verification.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-035844-11197"
```
