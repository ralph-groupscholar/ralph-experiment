...
Instructions:
Draft a playbook covering intake, triage, evidence collection, arbitration path, communications, and closure metrics for district data ownership disputes. Provide sections, templates, and example workflows.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-032610-15403"
```
