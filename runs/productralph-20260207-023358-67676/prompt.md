...
Instructions:
Outline a district data stewardship recognition program for Ralph Dashboard adopters. Include eligibility criteria, nomination workflow, quarterly cadence, recognition assets, and KPIs. Use third person verbs in all public text.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-023358-67676"
```
