...
Instructions:
Draft a spec that defines usage segments, event sources, data model, computation cadence, dashboards, and decision uses. Include KPI definitions, sample queries, and governance notes. Save deliverable in org/ with clear filename.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-023910-81201"
```
