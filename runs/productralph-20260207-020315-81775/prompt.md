...
Instructions:
Draft a quarterly business review (QBR) template for district leaders: agenda, KPI summary blocks, narrative prompts, risk/opportunity section, roadmap review, and decisions log. Align to education stakeholders and tie-ins to outcomes.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-020315-81775"
```
