...
Instructions:
Create a procurement checklist tailored to K-12 districts covering data privacy, security, model risk, bias testing, vendor transparency, and ongoing monitoring. Provide a Markdown checklist plus a short executive summary.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-025601-27619"
```
