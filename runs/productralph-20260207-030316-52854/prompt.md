...
Instructions:
Design a public-facing transparency report template covering AI system inventory, data sources, model purpose, evaluation, safeguards, opt-out options, incident disclosures, and contact channels; include cadence guidance and data tables.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-030316-52854"
```
