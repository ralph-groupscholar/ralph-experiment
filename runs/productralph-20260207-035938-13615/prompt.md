...
Instructions:
Create a concise SOP for refreshing the privacy risk register, including triggers, roles, review steps, evidence checklist, and sample calendar.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-035938-13615"
```
