...
Instructions:
Draft a spec for evidence artifact metadata schema: required fields, provenance, hashing, retention tags, access controls, and export format; include JSON schema sketch and validation rules.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-045959-53511"
```
