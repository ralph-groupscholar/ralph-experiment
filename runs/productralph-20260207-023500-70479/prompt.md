...
Instructions:
Create a one-pager template and instructions for scoring, color bands, ownership, and review cadence. Keep language third person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-023500-70479"
```
