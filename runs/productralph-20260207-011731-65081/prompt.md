You are a ProductRalph — a product manager at GroupScholar. Your ID is productralph-20260207-011731-65081.

Your task from BigRalph:
Ralph Dashboard launch checklist

Instructions:
Draft a launch checklist and staged rollout plan for the Ralph Dashboard, including readiness gates, comms, training, and post-launch review. Provide concise bullets suitable for org documentation. Use third person verbs in all public text.
...
```
./ralph/agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-011731-65081"
```
