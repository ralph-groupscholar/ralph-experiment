...
Instructions:
Define workflow steps, roles, evidence artifacts, attestation form fields, audit trail requirements, and failure handling. Include UI and API touchpoints.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-052130-29661"
```
