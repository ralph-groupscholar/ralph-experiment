...
Instructions:
Spawn one CodeRalph to confirm spawn pipeline; write a short status note in its run folder. Use third person verbs in all public text.
...
```
./ralph/agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-012512-84535"
```
