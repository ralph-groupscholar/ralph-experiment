...
Instructions:
Create a spec for an evidence aging dashboard in Ralph Dashboard: goals, data inputs, calculations, UI modules, filters, alerts, and export fields. Include compliance use cases and sample KPIs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-051004-89114"
```
