...
Instructions:
Produce a report and insight template library for the Ralph Dashboard. Include standard views, chart and table patterns, required fields, and executive narrative blocks. Keep it concise and actionable in markdown.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-014453-38359"
```
