...
Instructions:
Create a scorecard template to evaluate vendor SLAs for district data governance, including scoring rubric, evidence requirements, and decision guidance. Use third person verbs for public text.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-050458-75772"
```
