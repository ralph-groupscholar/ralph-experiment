...
Instructions:
Create a concise incident metrics taxonomy for Ralph Dashboard: definitions, calculation notes, owner, cadence, and sample dashboard layout. Output in markdown with sections and a one-page summary.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-032127-2030"
```
