...
Instructions:
Create a template that maps upstream/downstream dependencies, owners, SLAs, SLOs, data freshness expectations, and escalation paths. Include guidance on how to populate and maintain the matrix. Write in third person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-034003-59223"
```
