...
Instructions:
Produce a component inventory for Ralph Dashboard (navigation, tables, cards, charts, filters, forms, modals, notifications, empty states, loading, error states). Include accessibility requirements and usage guidance. Write in third person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-031957-97624"
```
