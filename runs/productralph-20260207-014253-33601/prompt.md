...
Instructions:
Create a concise OKR set (company, product, and ops) with measurable KPI targets for the next 2 quarters. Include rationale and target ranges.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-014253-33601"
```
