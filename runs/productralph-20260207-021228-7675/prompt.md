...
Instructions:
Create a staffing model for Ralph Dashboard implementation: roles, FTE ranges by district size, skills, onboarding timeline, and handoff points. Include budget bands and risks.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-021228-7675"
```
