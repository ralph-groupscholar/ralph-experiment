...
Instructions:
Draft a policy doc covering data residency options, regional hosting commitments, cross-region replication, failover triggers, customer notifications, and FAQ for districts. Include decision tree and non-promises language.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-024413-95118"
```
