...
Instructions:
Define the customer support model for the Ralph Dashboard: tiers, SLAs, escalation matrix, tooling, staffing assumptions, and weekly reporting. Output to an org/ document.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-013615-14750"
```
