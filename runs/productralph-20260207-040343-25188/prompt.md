...
Instructions:
Draft a UX spec for a self-serve customer audit portal in the Ralph Dashboard. Cover navigation, evidence catalogs, filtering, export formats, access controls, redaction rules, audit trails, error states, and success metrics.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-040343-25188"
```
