...
Instructions:
Create a UX spec for verifying and visualizing data provenance checks, including user flows, UI components, audit evidence export, and edge cases. Store outputs under the standard productralph output path and keep language in third person.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-050339-63860"
```
