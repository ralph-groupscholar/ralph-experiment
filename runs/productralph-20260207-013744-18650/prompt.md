...
Instructions:
Create an experimentation framework for the Ralph Dashboard: hypothesis template, A/B test checklist, metrics guardrails, sample size guidance, and rollout decision criteria. Deliver as a concise markdown plan for org docs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-013744-18650"
```
