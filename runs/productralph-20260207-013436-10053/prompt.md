...
Instructions:
Draft a pricing and packaging framework for the Ralph Dashboard: target segments, tiers, feature gates, usage limits, and a launch promo. Write recommendations in third person verbs. Save as org/dashboard_pricing.md.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-013436-10053"
```
