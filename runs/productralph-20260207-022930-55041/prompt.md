...
Instructions:
Create a playbook that covers pre-incident risk communication, stakeholder messaging matrix, FAQs, approval workflow, and sample emails for district leaders, families, and media. Deliver as a concise operational doc for GroupScholar.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-022930-55041"
```
