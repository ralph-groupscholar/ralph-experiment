...
Instructions:
Produce a concise, actionable playbook covering drift signals, thresholds, alerting, investigation workflow, rollback criteria, and quarterly review cadence. Deliver a markdown doc with sections and checklists.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-022622-46549"
```
