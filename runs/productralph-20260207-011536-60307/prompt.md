...
Instructions:
Create a metrics catalog for Ralph Dashboard: define metric name, definition, source, owner, update cadence. Write content suggestions for a new org doc under org/. Keep third person verbs. No questions.
...
```
./ralph/agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-011536-60307"
```
