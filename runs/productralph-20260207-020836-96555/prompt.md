...
Instructions:
Create a facilitator guide with objectives, roles, injects, timelines, decision logs, and after-action template. Emphasize K-12 data governance, FERPA/COPPA scenarios, and escalation paths. Provide checklists and sample artifacts.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-020836-96555"
```
