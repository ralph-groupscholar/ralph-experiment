...
Instructions:
Draft a workflow spec covering triggers, roles, approval steps, audit logging, retention overrides, and release criteria for legal holds across district tenants. Include UX touchpoints, required data fields, and KPIs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-035504-1333"
```
