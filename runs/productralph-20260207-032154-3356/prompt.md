...
Instructions:
Produce a QBR narrative outline tailored for district executives: sections, key story arcs, metric callouts, and decision prompts. Keep it one page in markdown.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-032154-3356"
```
