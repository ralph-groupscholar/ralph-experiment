...
Instructions:
Define SLIs/thresholds, data freshness tiers, alert routing, escalation, and sample monitoring queries for core data sources. Include ownership and review cadence.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-021924-27031"
```
