...
Instructions:
Provide TAM/SAM/SOM estimates framework, assumptions, segments, and a 1-page narrative on market sizing approach.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-014255-33744"
```
