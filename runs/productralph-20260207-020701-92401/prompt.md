...
Instructions:
Build a communications kit for Ralph Dashboard data sharing: stakeholder email templates, FAQ, and announcement timeline.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-020701-92401"
```
