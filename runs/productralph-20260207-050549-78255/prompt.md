...
Instructions:
Create a playbook for collecting, analyzing, and acting on training feedback. Include survey templates, cadence, owners, and improvement backlog workflow.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-050549-78255"
```
