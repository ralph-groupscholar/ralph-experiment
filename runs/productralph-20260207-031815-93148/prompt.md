...
Instructions:
Build a month-by-month communications calendar aligned to school-year phases: key messages, audience segments, channels, assets, owners, and dependency notes.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-031815-93148"
```
