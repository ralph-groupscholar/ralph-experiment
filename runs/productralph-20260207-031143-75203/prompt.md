...
Instructions:
Provide a budgeting framework, cost categories, funding sources, approval timeline, and a 12‑month budget worksheet outline. Keep it ready for district leaders.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-031143-75203"
```
