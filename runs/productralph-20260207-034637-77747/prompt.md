...
Instructions:
Create a UX spec for a self-serve role builder: user goals, roles/permissions model, guardrails, templates, approval flows, auditability, error states, access reviews, analytics, and wireframe descriptions. Deliver in org/ as a markdown doc.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-034637-77747"
```
