...
Instructions:
Draft a quarterly release readiness checklist with owner roles, go/no-go criteria, data backfill verification, customer comms, training updates, rollback triggers, and post-release validation. Keep it actionable and audit-friendly.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-024617-801"
```
