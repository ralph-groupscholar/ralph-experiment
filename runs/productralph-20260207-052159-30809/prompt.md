...
Instructions:
Produce a spec for a trust center incident timeline viewer: user stories, data model, UI modules, filters, export, roles, audit logging, SLA alignment, and success metrics. Save output in the appropriate productralph output location.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-052159-30809"
```
