...
Instructions:
Create a launch kit covering positioning, member recruitment, agenda for first 3 sessions, facilitation guide, communications templates, and success metrics for a district data governance community of practice.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-033019-26766"
```
