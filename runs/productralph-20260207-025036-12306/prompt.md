...
Instructions:
Draft an SOP covering encryption key generation, storage (HSM/KMS), access control, rotation schedules, incident response for key compromise, auditing, and compliance mapping. Include roles and RACI plus verification checklist.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-025036-12306"
```
