...
Instructions:
Produce a concise playbook covering roles, monthly routines, escalation paths, and sample communications for school principals. Include a 30-60-90 day rollout. Store output in runs/ with timestamped folder and a README.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-025901-35714"
```
