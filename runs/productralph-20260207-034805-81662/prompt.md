...
Instructions:
Draft a concise KPI/SLO framework for incident response in Ralph Dashboard: metrics definitions, target thresholds, reporting cadence, dashboard layout, and ownership. Deliver in a single markdown file with sections and tables.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-034805-81662"
```
