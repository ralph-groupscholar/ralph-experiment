...
Instructions:
Create a KPI operating scorecard template for district data governance: metrics, targets, cadence, data sources, and owners. Deliver as markdown doc in org/.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-031753-91912"
```
