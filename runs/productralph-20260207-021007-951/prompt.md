...
Instructions:
Draft a governance SOP for the Ralph Dashboard data dictionary, including ownership, change control, approval steps, review cadence, and audit trail requirements.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-021007-951"
```
