...
Instructions:
Draft a status reporting packet for the Ralph Dashboard program: weekly update template, KPIs, milestones, risks, decisions, and dependencies. Include example filled-out week and guidance on cadence.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-014206-30675"
```
