...
Instructions:
Create a charter for a district data steward community program: goals, cadence, membership criteria, activities, success metrics, and resourcing.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-025633-29031"
```
