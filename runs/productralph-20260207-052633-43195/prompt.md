...
Instructions:
Produce a scorecard template and scoring rubric for vendor exit readiness (data portability, deletion, contractual obligations, continuity, comms). Include scoring scale, evidence checklist, and remediation actions.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-052633-43195"
```
