...
Instructions:
Create an ORR checklist with gates, owners, evidence links, and launch sign-off criteria.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-030500-57800"
```
