...
Instructions:
Produce a concise checklist that validates parity between UI exports, API exports, and scheduled reports. Include scope, prerequisites, sampling plan, validation steps, exception handling, and sign-off. Write in third person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-032249-6363"
```
