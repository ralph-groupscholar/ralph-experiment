...
Instructions:
Create a practical template and guidance for generating a post-deletion proof of compliance report for districts. Include required sections, evidence checklist, roles, timelines, and customer-facing version.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-030252-51595"
```
