...
Instructions:
Draft an annual planning calendar for a district data governance council. Include cadence by month, key deliverables, decision gates, stakeholder touchpoints, and alignment with school-year milestones. Provide a table and brief narrative.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-030229-50390"
```
