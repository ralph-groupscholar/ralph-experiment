...
Instructions:
Create a playbook template with roles, contact methods, escalation timing, and blackout constraints for district comms during incidents.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-031404-81964"
```
