...
Instructions:
Create a concise, executive-ready annual report template for district data governance. Include sections, KPIs, narrative prompts, evidence checklist, and publication cadence. Use third person verbs in all public text.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-023358-67675"
```
