...
Instructions:
Defines incident command roles, responsibilities, and a structured handoff checklist for on-call transitions. Uses third person verbs, operational detail, and produces a ready-to-run playbook in org/.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-033731-52612"
```
