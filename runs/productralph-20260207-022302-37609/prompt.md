...
Instructions:
Create a SOP that defines redaction steps, tooling expectations, escalation triggers, and QA checks for PII in support artifacts; include a checklist. Write in third-person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-022302-37609"
```
