...
Instructions:
Outline pre-launch checklists, go-live hour-by-hour plan, monitoring checklist, decision tree for rollback, comms templates, and owner assignments.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-021928-27345"
```
