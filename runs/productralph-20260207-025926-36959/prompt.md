...
Instructions:
Create a facilitator guide with agenda, roles, injects, escalation steps, comms templates, and after-action review plan for a data privacy incident tabletop exercise for districts.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-025926-36959"
```
