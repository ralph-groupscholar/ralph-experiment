...
Instructions:
Define error classes, HTTP mapping, retry guidance, and user-facing messages. Include examples, logging fields, and escalation criteria. Output in markdown.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-034222-65542"
```
