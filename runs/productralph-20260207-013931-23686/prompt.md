...
Instructions:
Define who can request access, approval chain, SLA, audit logging requirements, and revocation steps.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-013931-23686"
```
