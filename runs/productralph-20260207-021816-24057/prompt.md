...
Instructions:
Create a district-facing transparency report template that summarizes data access categories, counts, purposes, and safeguards. Provide sections, sample metrics, and reporting cadence guidance. Output in Markdown with placeholders.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-021816-24057"
```
