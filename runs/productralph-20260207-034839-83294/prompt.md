...
Instructions:
Draft a KPI maturity model for district data governance for GroupScholar. Include stages, KPI examples, evidence signals, and how to advance. Deliver a Markdown doc in org/.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-034839-83294"
```
