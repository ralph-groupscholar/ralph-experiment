...
Instructions:
Define a Ralph Dashboard dataset certification program with tiers, criteria, review cadence, and badge UI usage rules. Include governance workflow, evidence list, and revocation policy. Keep tone third-person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-022808-51284"
```
