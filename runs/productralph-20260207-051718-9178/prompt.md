...
Instructions:
Draft a playbook covering e-discovery readiness for Ralph Dashboard data: preservation triggers, legal holds, collection workflows, chain-of-custody, search protocols, redaction, and audit evidence alignment.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-051718-9178"
```
