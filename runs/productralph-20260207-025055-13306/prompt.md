...
Instructions:
Create a concise SOP for long-term data archival, retrieval SLAs, audit trails, and access approvals. Save as a new org doc with clear sections and an implementation checklist.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-025055-13306"
```
