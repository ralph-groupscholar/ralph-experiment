...
Instructions:
Produce a reusable register template and a short approvals workflow for retention exceptions; include fields, owner roles, review cadence, and audit evidence. Write in third-person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-022300-37462"
```
