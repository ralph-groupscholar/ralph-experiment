...
Instructions:
Draft a model and guidance that forecast district data request workloads by month, including drivers, seasonality, and staffing capacity planning. Provide assumptions, inputs, calculation steps, and an example scenario.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-052411-37109"
```
