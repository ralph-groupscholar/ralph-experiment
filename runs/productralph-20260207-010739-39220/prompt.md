...
Instructions:
Define MVP dashboard modules, key interactions, and layout constraints. Keep to 1 page spec.
...
```
./ralph/agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-010739-39220"
```
