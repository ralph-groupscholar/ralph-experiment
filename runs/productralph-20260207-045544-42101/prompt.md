...
Instructions:
Define UX for a status tracker that shows privacy/data requests lifecycle states, SLAs, milestones, and evidence attachments. Include user roles, page layout, filters, edge cases, empty states, and notification triggers. Provide key UI copy.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-045544-42101"
```
