...
Instructions:
Produce a spec for a composite trust score in the Ralph Dashboard. Include metric inputs, weighting rationale, normalization, confidence intervals, and anti-gaming controls. Deliver a markdown template plus implementation notes.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-045716-46216"
```
