...
Instructions:
Draft customer-facing trust center incident history timeline content guidelines, governance workflow, review cadence, and update SLAs. Include redaction rules, legal/privacy guardrails, and template entries.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-031448-83860"
```
