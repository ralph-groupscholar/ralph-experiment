...
Instructions:
Create a detailed product spec for a retention vs. legal-hold conflict resolver: inputs, rules engine, precedence, audit trails, UI flows, notifications, and failure modes. Include data model, API endpoints, and admin controls.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-052631-43057"
```
