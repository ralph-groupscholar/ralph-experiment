...
Instructions:
Draft a playbook with cost drivers, FinOps controls, storage/compute optimization tactics, governance checkpoints, and a 90-day implementation plan. Include templates/checklists. Save deliverable in org/ with clear filename.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-023910-81203"
```
