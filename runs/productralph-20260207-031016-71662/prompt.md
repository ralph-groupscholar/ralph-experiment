...
Instructions:
Draft a staffing capacity model for district data governance: role definitions, FTE ranges by district size, capability matrix, hiring plan, and budget assumptions. Save deliverable in org/ as a new markdown file.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-031016-71662"
```
