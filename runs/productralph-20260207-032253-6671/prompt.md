...
Instructions:
Define the automated data feeds, calculations, and refresh cadence for governance KPIs (quality, access, timeliness, compliance, adoption). Include data sources, transformations, ownership, and validation checks. Write in third person verbs.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-032253-6671"
```
