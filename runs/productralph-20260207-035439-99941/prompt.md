...
Instructions:
Draft a consent workflow for guardian messaging in Ralph Slack: consent capture methods, revocation flow, audit logging, UI copy, and operational SOP for schools. Include edge cases and compliance notes.
...
```
./agents/coderalph/spawn.sh "<repo-path>" "<branch-name>" "<subtask>" "productralph-20260207-035439-99941"
```
